...
#define I2C12_MULTI_CH_EN 0
#define I2C13_MULTI_CH_EN 0
#if I2C2_MULTI_CH_EN
    #define I2C2_BASE_OFFSET  0x100
    #define I2C2_APDMA_OFFSET 0x80
#else
    #define I2C2_BASE_OFFSET  0x0
    #define I2C2_APDMA_OFFSET 0x0
#endif
#if I2C4_MULTI_CH_EN
    #define I2C4_BASE_OFFSET  0x100
    #define I2C4_APDMA_OFFSET 0x80
#else
    #define I2C4_BASE_OFFSET  0x0
    #define I2C4_APDMA_OFFSET 0x0
#endif
#if I2C7_MULTI_CH_EN
    #define I2C7_BASE_OFFSET  0x100
    #define I2C7_APDMA_OFFSET 0x80
#else
    #define I2C7_BASE_OFFSET  0x0
    #define I2C7_APDMA_OFFSET 0x0
#endif
#if I2C8_MULTI_CH_EN
    #define I2C8_BASE_OFFSET  0x100
    #define I2C8_APDMA_OFFSET 0x80
#else
    #define I2C8_BASE_OFFSET  0x0
    #define I2C8_APDMA_OFFSET 0x0
#endif
#if I2C9_MULTI_CH_EN
    #define I2C9_BASE_OFFSET  0x100
    #define I2C9_APDMA_OFFSET 0x80
#else
    #define I2C9_BASE_OFFSET  0x0
    #define I2C9_APDMA_OFFSET 0x0
#endif
#if I2C12_MULTI_CH_EN
    #define I2C12_BASE_OFFSET  0x100
    #define I2C12_APDMA_OFFSET 0x80
#else
    #define I2C12_BASE_OFFSET  0x0
    #define I2C12_APDMA_OFFSET 0x0
#endif
#if I2C13_MULTI_CH_EN
    #define I2C13_BASE_OFFSET  0x100
    #define I2C13_APDMA_OFFSET 0x80
#else
    #define I2C13_BASE_OFFSET  0x0
    #define I2C13_APDMA_OFFSET 0x0
#endif
