...
void mminfra_hre_bkrs(unsigned int select)
{
    ...
    /* TINFO = "[SSPM][MMINFRA] Set Backup/Restore Settings" */
        ...
        mm_write(MMINFRA_HRE_ADDR_BASE + 0x000, 0x10);
        ...
        mm_write(MMINFRA_HRE_ADDR_BASE + 0x038, 0x1e80b100);  //rg_bk10_addr_ip
        mm_write(MMINFRA_HRE_ADDR_BASE + 0x03C, 0x1e80b220);  //rg_bk11_addr_ip
        ...
        mm_write(MMINFRA_HRE_ADDR_BASE + 0x04C, 0x1e800a28);  //rg_bk15_addr_ip
        ...
        mm_write(MMINFRA_HRE_ADDR_BASE + 0x078, 0x1e900ab8);  //rg_bk6_addr_sram
        mm_write(MMINFRA_HRE_ADDR_BASE + 0x07C, 0x1e900ad8);  //rg_bk7_addr_sram
        mm_write(MMINFRA_HRE_ADDR_BASE + 0x080, 0x1e900af0);  //rg_bk8_addr_sram
        mm_write(MMINFRA_HRE_ADDR_BASE + 0x084, 0x1e900b14);  //rg_bk9_addr_sram
        mm_write(MMINFRA_HRE_ADDR_BASE + 0x088, 0x1e900bf8);  //rg_bk10_addr_sram
        mm_write(MMINFRA_HRE_ADDR_BASE + 0x08C, 0x1e900c1c);  //rg_bk11_addr_sram
        ...
        mm_write(MMINFRA_HRE_ADDR_BASE + 0x09C,  0x1e900e0c); //rg_bk15_addr_sram
        ...
        mm_write(MMINFRA_HRE_ADDR_BASE + 0x0B4, 0x06087B80);  //rg_count1
        mm_write(MMINFRA_HRE_ADDR_BASE + 0x0B8, 0x39093909);  //rg_count2
        mm_write(MMINFRA_HRE_ADDR_BASE + 0x0BC, 0x14013909);  //rg_count3
        // mm_write(MMINFRA_HRE_ADDR_BASE + 0x0C0, 0x0);         //rg_count4
        mm_write(MMINFRA_HRE_ADDR_BASE + 0x0C4, 0xFFFF);      //rg_hre_seq_en
