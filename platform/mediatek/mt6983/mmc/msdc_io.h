...
#define MSDC0_GPIO_DRV0_ADDR_0   (MSDC0_IO_PAD_BASE + 0x00)
#define MSDC0_GPIO_DRV0_ADDR_1   (MSDC0_IO_PAD_BASE + 0x10)
...
#define MSDC0_GPIO_RDSEL0_ADDR_0 (MSDC0_IO_PAD_BASE + 0x90)
#define MSDC0_GPIO_RDSEL0_ADDR_1 (MSDC0_IO_PAD_BASE + 0xa0)
#define MSDC0_GPIO_RDSEL0_ADDR_2 (MSDC0_IO_PAD_BASE + 0xb0)
#define MSDC0_GPIO_SMT_ADDR      (MSDC0_IO_PAD_BASE + 0xd0)
#define MSDC0_GPIO_TDSEL0_ADDR_0 (MSDC0_IO_PAD_BASE + 0xf0)
#define MSDC0_GPIO_TDSEL0_ADDR_1 (MSDC0_IO_PAD_BASE + 0x100)
...
#define MSDC0_MODE_DAT3_MASK     (0x7 << 8)
...
#define MSDC0_IES_DAT_MASK       (0xFF << 3)
#define MSDC0_IES_DSL_MASK       (0x1 << 11)
#define MSDC0_IES_RSTB_MASK      (0x1 << 12)
#define MSDC0_IES_ALL_MASK       (0x7FF << 1)
/* MSDC0 SMT mask */
