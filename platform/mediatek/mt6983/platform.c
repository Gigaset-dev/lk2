...
{
    PROFILING(ufs_deinit());
    PROFILING(pmif_enable_mpu());
    platform_stop_timer();
...
void platform_sec_post_init(void)
{
    ...
    devapc_protection_enable(DEVAPC_MMUP);
}
