...
const unsigned long cpu_dbg_sel[] = {
    (MCUCFG_BASE + 0x180120),
    (MCUCFG_BASE + 0x190120),
    (MCUCFG_BASE + 0x1A0120),
    (MCUCFG_BASE + 0x1B0120),
    (MCUCFG_BASE + 0x1C0020),
    (MCUCFG_BASE + 0x1D0020),
    (MCUCFG_BASE + 0x1E0020),
    (MCUCFG_BASE + 0x1F0020)
};

const unsigned long cpu_dbg_mon[] = {
    (MCUCFG_BASE + 0x180124),
    (MCUCFG_BASE + 0x190124),
    (MCUCFG_BASE + 0x1A0124),
    (MCUCFG_BASE + 0x1B0124),
    (MCUCFG_BASE + 0x1C0024),
    (MCUCFG_BASE + 0x1D0024),
    (MCUCFG_BASE + 0x1E0024),
    (MCUCFG_BASE + 0x1F0024)
};
