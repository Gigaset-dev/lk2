...
/* SRAM for Thermal */
#define THERMAL_SRAM_BASE  (SRAM_BASE + 0x00014000) //0x114000
#define THERMAL_SRAM_LEN   0x400
#define THERMAL_BUF_LENGTH 0x1000
#define THERMAL_ATC_SRAM_BASE   (THERMAL_SRAM_BASE + 0x280)
#define THERMAL_ATC_SRAM_LEN    (18 * 4)

/* APU MBOX */
#define APU_MBOX_THERMAL_BASE   (APUSYS_BASE + 0x000E1700)
#define APU_MBOX_THERMAL_LEN    (28)
...
void thermal_cls_sram(uint level)
{
    ...
    len = (unsigned int)THERMAL_SRAM_LEN;
    ...
    for (i = 0; i < APU_MBOX_THERMAL_LEN ; i = i + 4)
        memcpy((void *)APU_MBOX_THERMAL_BASE + i, &pattern, 4);
}
