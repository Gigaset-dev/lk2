...
#define DISP_REG_AAL_SHADOW_CTRL                (DISPSYS_AAL0_BASE + 0x0F0)
...
#define DISP_MDP_AAL0_MDP_AAL_SIZE                   (DISPSYS_MDP_AAL0_BASE+0x030)
#define DISP_MDP_AAL0_MDP_AAL_OUTPUT_SIZE            (DISPSYS_MDP_AAL0_BASE+0x034)
#define DISP_MDP_AAL0_MDP_AAL_EN                     (DISPSYS_MDP_AAL0_BASE+0x000)
#define DISP_MDP_AAL0_MDP_AAL_CFG                    (DISPSYS_MDP_AAL0_BASE+0x020)
#define DISP_MDP_AAL0_MDP_AAL_CFG_MAIN               (DISPSYS_MDP_AAL0_BASE+0x200)
#define DISP_MDP_AAL0_MDP_AAL_DRE_BILATERAL          (DISPSYS_MDP_AAL0_BASE+0x53C)
...
/* ------------------------------------------------------------- */
/* C3D */
#define DISP_REG_C3D0_C3D_EN                                        (DISPSYS_C3D0_BASE + 0x000)
#define DISP_REG_C3D0_C3D_CFG                                       (DISPSYS_C3D0_BASE + 0x004)
#define DISP_REG_C3D0_C3D_SIZE                                      (DISPSYS_C3D0_BASE + 0x024)
#define DISP_REG_C3D_SHADOW_CTRL    (DISPSYS_C3D0_BASE + 0x030)
#define FLD_C3D_BYPASS_SHADOW            REG_FLD(1, 0)
#define FLD_C3D_READ_WRK_REG             REG_FLD(1, 2)

/* ------------------------------------------------------------- */
/* disp tdshp0 */
#define DISP_TDSHP0_DISP_TDSHP_00               (DISP_TDSHP0_BASE + 0x0)
#define DISP_TDSHP0_DISP_TDSHP_INPUT_SIZE       (DISP_TDSHP0_BASE + 0x120)
#define DISP_TDSHP0_DISP_TDSHP_OUTPUT_SIZE      (DISP_TDSHP0_BASE + 0x128)
#define DISP_TDSHP0_DISP_TDSHP_OUTPUT_OFFSET    (DISP_TDSHP0_BASE + 0x124)
#define DISP_TDSHP0_DISP_TDSHP_CTRL                (DISP_TDSHP0_BASE + 0x100)
#define DISP_TDSHP0_DISP_TDSHP_CFG                (DISP_TDSHP0_BASE + 0x110)
#define DISP_REG_TDSHP_SHADOW_CTRL                (DISP_TDSHP0_BASE + 0x67C)
#define FLD_TDSHP_BYPASS_SHADOW            REG_FLD(1, 0)
#define FLD_TDSHP_READ_WRK_REG             REG_FLD(1, 2)

/* ------------------------------------------------------------- */
/* disp chist0 */
#define DISP_CHIST_EN                (DISPSYS_CHIST_BASE + 0x0)
#define DISP_CHIST_INTEN             (DISPSYS_CHIST_BASE + 0x08)
#define DISP_CHIST_CFG               (DISPSYS_CHIST_BASE + 0x20)
#define DISP_CHIST_SIZE              (DISPSYS_CHIST_BASE + 0x30)
#define DISP_CHIST_SHADOW_CTRL       (DISPSYS_CHIST_BASE + 0xF0)
