...
struct ddp_module ddp_modules[DISP_MODULE_NUM] = {
        ...
        {DISP_MODULE_CHIST0, "disp_chist0", 1, &ddp_driver_chist},
        {DISP_MODULE_CHIST1, "disp_chist1", 1, &ddp_driver_chist},

        {DISP1_MODULE_CHIST0, "disp1_chist0", 1, &ddp_driver_chist}, /* 90 */
        {DISP1_MODULE_CHIST1, "disp1_chist1", 1, &ddp_driver_chist},
