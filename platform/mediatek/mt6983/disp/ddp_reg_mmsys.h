...
#define DISP1_REG_CONFIG_MMSYS_MISC        (DISPSYS1_CONFIG_BASE + 0x0F0)
    ...
    #define FLD_OVL0_2L_ULTRA_SEL        REG_FLD_MSB_LSB(11, 10)
    #define FLD_OVL1_2L_ULTRA_SEL        REG_FLD_MSB_LSB(7, 6)

#define DISP_REG_CONFIG_MMSYS_SODI_REQ_MASK        (DISPSYS_CONFIG_BASE + 0x0F4)
#define DISP1_REG_CONFIG_MMSYS_SODI_REQ_MASK       (DISPSYS1_CONFIG_BASE + 0x0F4)

#define DISP_REG_CONFIG_MMSYS_EMI_REQ_CTL        (DISPSYS_CONFIG_BASE + 0x0F8)
#define DISP1_REG_CONFIG_MMSYS_EMI_REQ_CTL       (DISPSYS1_CONFIG_BASE + 0x0F8)
...
#define DISP_REG_CONFIG_DISP_CHIST0_SEL_IN                        (DISPSYS_CONFIG_BASE + 0xF50)
#define DISP_REG_CONFIG_DISP_CHIST1_SEL_IN                        (DISPSYS_CONFIG_BASE + 0xF54)
...
#define DISP1_REG_CONFIG_DISP_CHIST0_SEL_IN                        (DISPSYS1_CONFIG_BASE + 0xF50)
#define DISP1_REG_CONFIG_DISP_CHIST1_SEL_IN                        (DISPSYS1_CONFIG_BASE + 0xF54)
...
#define DISP1_REG_CONFIG_MMSYS_OVL_CON            (DISPSYS1_CONFIG_BASE + 0xF08)
    ...
    #define FLD_CON_OVL1_2L                         REG_FLD(2, 2)
    #define FLD_CON_OVL0_2L                         REG_FLD(2, 4)
