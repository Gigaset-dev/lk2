...
static struct smem_region_lk s_nc_ref_tbl[] = {
    ...
    {{SMEM_USER_MD_WIFI_PROXY,    0, 32 * 1024,          0,               0, 0},
                                                                          NULL},
    {{SMEM_USER_RAW_AMMS_POS,     0, 0,          0x10000,   SMEM_ATTR_MD_NC, 0},
                                                                          NULL},

    {{SMEM_USER_RAW_MDCCCI_DBG,   0, 2 * 1024,   0,         SMEM_ATTR_MD_NC, 0},
                                                                          NULL},
    {{SMEM_USER_RAW_MDSS_DBG,     0, 14 * 1024,  0,         SMEM_ATTR_MD_NC, 0},
                                                                          NULL},
    {{SMEM_USER_RAW_RESERVED,     0, 42 * 1024,  0,         SMEM_ATTR_MD_NC, 0},
                                                                          NULL},
    {{SMEM_USER_RAW_RUNTIME_DATA, 0, 4 * 1024,   0,         SMEM_ATTR_MD_NC, 0},
                                                                          NULL},
    {{SMEM_USER_RAW_FORCE_ASSERT, 0, 1 * 1024,   0,         SMEM_ATTR_MD_NC, 0},
                                                                          NULL},
    {{SMEM_USER_LOW_POWER,        0, 512,        0,         SMEM_ATTR_MD_NC, 0},
                                                                          NULL},
    {{SMEM_USER_RAW_DBM,          0, 512,        0,         SMEM_ATTR_MD_NC, 0},
                                                                          NULL},
    {{SMEM_USER_CCISM_SCP,        0, 32 * 1024,  0,         SMEM_ATTR_MD_NC, 0},
                                                                          NULL},
    {{SMEM_USER_RAW_CCB_CTRL,     0, 4 * 1024,   0,         SMEM_ATTR_MD_NC, 0},
                                                                          NULL},
    {{SMEM_USER_RAW_NETD,         0, 8 * 1024,   0,         SMEM_ATTR_MD_NC, 0},
                                                                          NULL},
    {{SMEM_USER_RAW_USB,          0, 4 * 1024,   0,         SMEM_ATTR_MD_NC, 0},
                                                                          NULL},
    {{SMEM_USER_RAW_AUDIO,        0, 52 * 1024,  0,         SMEM_ATTR_MD_NC, 0},
                                                                          NULL},
    {{SMEM_USER_CCISM_MCU,        0, 721 * 1024, 0,         SMEM_ATTR_MD_NC, 0},
                                                                          NULL},
    {{SMEM_USER_CCISM_MCU_EXP,    0, 121 * 1024, 0,         SMEM_ATTR_MD_NC, 0},
                                                                          NULL},
};

static struct smem_region_lk s_c_ref_tbl[] = {
    {{SMEM_USER_RAW_MD_CONSYS,   0, 0x2B00000,  0x10000,  SMEM_ATTR_NO_MAP, 0},
                                                          ccci_get_consys_size},
    {{SMEM_USER_MD_NVRAM_CACHE,  0, 0x1200000,  64,       0, 0},
                                                        ccci_get_nv_cache_size},
    {{SMEM_USER_CCB_START,       0, 0x1600000,  0x100000, 0, 0},
                                                             ccci_get_ccb_size},
    {{SMEM_USER_RAW_UDC_DESCTAB, 0, 0x1000,     0x10000,  0, 0},
                                                        ccci_get_udc_desc_size},
    {{SMEM_USER_RAW_USIP,        0, 384 * 1024, 128,      0, 0}, NULL},
};
