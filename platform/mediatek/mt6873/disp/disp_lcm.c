...
void parse_lcm_params_dt_node(int node_offset, LCM_PARAMS *lcm_params)
{
    ...
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-types",
                                &lcm_params->type);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-resolution",
                                &lcm_params->width);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-io_select_mode",
                                &lcm_params->io_select_mode);

    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dbi-port",
                                &lcm_params->dbi.port);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dbi-clock_freq",
                                &lcm_params->dbi.clock_freq);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dbi-data_width",
                                &lcm_params->dbi.data_width);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dbi-data_format",
                                &(lcm_params->dbi.data_format.color_order));
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dbi-cpu_write_bits",
                                &lcm_params->dbi.cpu_write_bits);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dbi-io_driving_current",
                                &lcm_params->dbi.io_driving_current);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dbi-msb_io_driving_current",
                                &lcm_params->dbi.msb_io_driving_current);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dbi-ctrl_io_driving_current",
                                &lcm_params->dbi.ctrl_io_driving_current);

    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dbi-te_mode",
                                &lcm_params->dbi.te_mode);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dbi-te_edge_polarity",
                                &lcm_params->dbi.te_edge_polarity);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dbi-te_vs_width_cnt_div",
                                &lcm_params->dbi.te_vs_width_cnt_div);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dbi-te_hs_delay_cnt",
                                &lcm_params->dbi.te_hs_delay_cnt);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dbi-te_vs_width_cnt",
                                &lcm_params->dbi.te_vs_width_cnt);

    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dbi-serial-params0",
                                &(lcm_params->dbi.serial.cs_polarity));
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dbi-serial-params1",
                                &(lcm_params->dbi.serial.css));
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dbi-serial-params2",
                                &(lcm_params->dbi.serial.sif_3wire));
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dbi-parallel-params0",
                                &(lcm_params->dbi.parallel.write_setup));
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dbi-parallel-params1",
                                &(lcm_params->dbi.parallel.read_hold));

    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dpi-mipi_pll_clk_ref",
                                &lcm_params->dpi.mipi_pll_clk_ref);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dpi-mipi_pll_clk_div1",
                                &lcm_params->dpi.mipi_pll_clk_div1);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dpi-mipi_pll_clk_div2",
                                &lcm_params->dpi.mipi_pll_clk_div2);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dpi-mipi_pll_clk_fbk_div",
                                &lcm_params->dpi.mipi_pll_clk_fbk_div);

    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dpi-dpi_clk_div",
                                &lcm_params->dpi.dpi_clk_div);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dpi-dpi_clk_duty",
                                &lcm_params->dpi.dpi_clk_duty);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dpi-PLL_CLOCK",
                                &lcm_params->dpi.PLL_CLOCK);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dpi-dpi_clock",
                                &lcm_params->dpi.dpi_clock);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dpi-ssc_disable",
                                &lcm_params->dpi.ssc_disable);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dpi-ssc_range",
                                &lcm_params->dpi.ssc_range);

    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dpi-width",
                                &lcm_params->dpi.width);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dpi-height",
                                &lcm_params->dpi.height);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dpi-bg_width",
                                &lcm_params->dpi.bg_width);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dpi-bg_height",
                                &lcm_params->dpi.bg_height);

    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dpi-clk_pol",
                                &lcm_params->dpi.clk_pol);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dpi-de_pol",
                                &lcm_params->dpi.de_pol);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dpi-vsync_pol",
                                &lcm_params->dpi.vsync_pol);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dpi-hsync_pol",
                                &lcm_params->dpi.hsync_pol);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dpi-hsync_pulse_width",
                                &lcm_params->dpi.hsync_pulse_width);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dpi-hsync_back_porch",
                                &lcm_params->dpi.hsync_back_porch);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dpi-hsync_front_porch",
                                &lcm_params->dpi.hsync_front_porch);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dpi-vsync_pulse_width",
                                &lcm_params->dpi.vsync_pulse_width);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dpi-vsync_back_porch",
                                &lcm_params->dpi.vsync_back_porch);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dpi-vsync_front_porch",
                                &lcm_params->dpi.vsync_front_porch);

    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dpi-format",
                                &lcm_params->dpi.format);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dpi-rgb_order",
                                &lcm_params->dpi.rgb_order);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dpi-is_serial_output",
                                &lcm_params->dpi.is_serial_output);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dpi-i2x_en",
                                &lcm_params->dpi.i2x_en);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dpi-i2x_edge",
                                &lcm_params->dpi.i2x_edge);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dpi-embsync",
                                &lcm_params->dpi.embsync);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dpi-lvds_tx_en",
                                &lcm_params->dpi.lvds_tx_en);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dpi-bit_swap",
                                &lcm_params->dpi.bit_swap);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dpi-intermediat_buffer_num",
                                &lcm_params->dpi.intermediat_buffer_num);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dpi-io_driving_current",
                                &lcm_params->dpi.io_driving_current);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dpi-lsb_io_driving_current",
                                &lcm_params->dpi.lsb_io_driving_current);

    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dsi-mode",
                                &lcm_params->dsi.mode);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dsi-switch_mode",
                                &lcm_params->dsi.switch_mode);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dsi-DSI_WMEM_CONTI",
                                &lcm_params->dsi.DSI_WMEM_CONTI);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dsi-DSI_RMEM_CONTI",
                                &lcm_params->dsi.DSI_RMEM_CONTI);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dsi-VC_NUM",
                                &lcm_params->dsi.VC_NUM);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dsi-lane_num",
                                &lcm_params->dsi.LANE_NUM);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dsi-data_format",
                                &(lcm_params->dsi.data_format.color_order));
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dsi-intermediat_buffer_num",
                                &lcm_params->dsi.intermediat_buffer_num);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dsi-ps",
                                &lcm_params->dsi.PS);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dsi-word_count",
                                &lcm_params->dsi.word_count);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dsi-packet_size",
                                &lcm_params->dsi.packet_size);

    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dsi-vertical_sync_active",
                                &lcm_params->dsi.vertical_sync_active);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dsi-vertical_backporch",
                                &lcm_params->dsi.vertical_backporch);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dsi-vertical_frontporch",
                                &lcm_params->dsi.vertical_frontporch);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dsi-vertical_frontporch_for_low_power",
                                &lcm_params->dsi.vertical_frontporch_for_low_power);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dsi-vertical_active_line",
                                &lcm_params->dsi.vertical_active_line);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dsi-horizontal_sync_active",
                                &lcm_params->dsi.horizontal_sync_active);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dsi-horizontal_backporch",
                                &lcm_params->dsi.horizontal_backporch);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dsi-horizontal_frontporch",
                                &lcm_params->dsi.horizontal_frontporch);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dsi-horizontal_blanking_pixel",
                                &lcm_params->dsi.horizontal_blanking_pixel);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dsi-horizontal_active_pixel",
                                &lcm_params->dsi.horizontal_active_pixel);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dsi-horizontal_bllp",
                                &lcm_params->dsi.horizontal_bllp);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dsi-line_byte",
                                &lcm_params->dsi.line_byte);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dsi-horizontal_sync_active_byte",
                                &lcm_params->dsi.horizontal_sync_active_byte);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dsi-horizontal_backportch_byte",
                                &lcm_params->dsi.horizontal_backporch_byte);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dsi-horizontal_frontporch_byte",
                                &lcm_params->dsi.horizontal_frontporch_byte);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dsi-rgb_byte",
                                &lcm_params->dsi.rgb_byte);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dsi-horizontal_sync_active_word_count",
                                &lcm_params->dsi.horizontal_sync_active_word_count);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dsi-horizontal_backporch_word_count",
                                &lcm_params->dsi.horizontal_backporch_word_count);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dsi-horizontal_frontporch_word_count",
                                &lcm_params->dsi.horizontal_frontporch_word_count);

    disp_fdt_getprop_u8_array(node_offset, "lcm_params-dsi-HS_TRAIL",
                                &lcm_params->dsi.HS_TRAIL);
    disp_fdt_getprop_u8_array(node_offset, "lcm_params-dsi-ZERO",
                                &lcm_params->dsi.HS_ZERO);
    disp_fdt_getprop_u8_array(node_offset, "lcm_params-dsi-HS_PRPR",
                                &lcm_params->dsi.HS_PRPR);
    disp_fdt_getprop_u8_array(node_offset, "lcm_params-dsi-LPX",
                                &lcm_params->dsi.LPX);
    disp_fdt_getprop_u8_array(node_offset, "lcm_params-dsi-TA_SACK",
                                &lcm_params->dsi.TA_SACK);
    disp_fdt_getprop_u8_array(node_offset, "lcm_params-dsi-TA_GET",
                                &lcm_params->dsi.TA_GET);
    disp_fdt_getprop_u8_array(node_offset, "lcm_params-dsi-TA_SURE",
                                &lcm_params->dsi.TA_SURE);
    disp_fdt_getprop_u8_array(node_offset, "lcm_params-dsi-TA_GO",
                                &lcm_params->dsi.TA_GO);
    disp_fdt_getprop_u8_array(node_offset, "lcm_params-dsi-CLK_TRAIL",
                                &lcm_params->dsi.CLK_TRAIL);
    disp_fdt_getprop_u8_array(node_offset, "lcm_params-dsi-CLK_ZERO",
                                &lcm_params->dsi.CLK_ZERO);
    disp_fdt_getprop_u8_array(node_offset, "lcm_params-dsi-LPX_WAIT",
                                &lcm_params->dsi.LPX_WAIT);
    disp_fdt_getprop_u8_array(node_offset, "lcm_params-dsi-CONT_DET",
                                &lcm_params->dsi.CONT_DET);
    disp_fdt_getprop_u8_array(node_offset, "lcm_params-dsi-CLK_HS_PRPR",
                                &lcm_params->dsi.CLK_HS_PRPR);
    disp_fdt_getprop_u8_array(node_offset, "lcm_params-dsi-CLK_HS_POST",
                                &lcm_params->dsi.CLK_HS_POST);
    disp_fdt_getprop_u8_array(node_offset, "lcm_params-dsi-DA_HS_EXIT",
                                &lcm_params->dsi.DA_HS_EXIT);
    disp_fdt_getprop_u8_array(node_offset, "lcm_params-dsi-CLK_HS_EXIT",
                                &lcm_params->dsi.CLK_HS_EXIT);

    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dsi-pll_select",
                                &lcm_params->dsi.pll_select);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dsi-pll_div1",
                                &lcm_params->dsi.pll_div1);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dsi-pll_div2",
                                &lcm_params->dsi.pll_div2);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dsi-fbk_div",
                                &lcm_params->dsi.fbk_div);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dsi-fbk_sel",
                                &lcm_params->dsi.fbk_sel);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dsi-rg_bir",
                                &lcm_params->dsi.rg_bir);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dsi-rg_bic",
                                &lcm_params->dsi.rg_bic);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dsi-rg_bp",
                                &lcm_params->dsi.rg_bp);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dsi-pll_clock",
                                &lcm_params->dsi.PLL_CLOCK);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dsi-dsi_clock",
                                &lcm_params->dsi.dsi_clock);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dsi-ssc_disable",
                                &lcm_params->dsi.ssc_disable);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dsi-ssc_range",
                                &lcm_params->dsi.ssc_range);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dsi-compatibility_for_nvk",
                                &lcm_params->dsi.compatibility_for_nvk);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dsi-cont_clock",
                                &lcm_params->dsi.cont_clock);

    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dsi-ufoe_enable",
                                &lcm_params->dsi.ufoe_enable);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dsi-ufoe_params",
                                &(lcm_params->dsi.ufoe_params.compress_ratio));
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dsi-edp_panel",
                                &lcm_params->dsi.edp_panel);

    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dsi-customization_esd_check_enable",
                                &lcm_params->dsi.customization_esd_check_enable);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dsi-esd_check_enable",
                                &lcm_params->dsi.esd_check_enable);

    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dsi-lcm_int_te_monitor",
                                &lcm_params->dsi.lcm_int_te_monitor);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dsi-lcm_int_te_period",
                                &lcm_params->dsi.lcm_int_te_period);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dsi-lcm_ext_te_monitor",
                                &lcm_params->dsi.lcm_ext_te_monitor);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dsi-lcm_ext_te_enable",
                                &lcm_params->dsi.lcm_ext_te_enable);

    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dsi-noncont_clock",
                                &lcm_params->dsi.noncont_clock);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dsi-noncont_clock_period",
                                &lcm_params->dsi.noncont_clock_period);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dsi-clk_lp_per_line_enable",
                                &lcm_params->dsi.clk_lp_per_line_enable);

    disp_fdt_getprop_u8_array(node_offset, "lcm_params-dsi-lcm_esd_check_table0",
                                &(lcm_params->dsi.lcm_esd_check_table[0].cmd));
    disp_fdt_getprop_u8_array(node_offset, "lcm_params-dsi-lcm_esd_check_table1",
                                &(lcm_params->dsi.lcm_esd_check_table[1].cmd));
    disp_fdt_getprop_u8_array(node_offset, "lcm_params-dsi-lcm_esd_check_table2",
                                &(lcm_params->dsi.lcm_esd_check_table[2].cmd));

    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dsi-switch_mode_enable",
                                &lcm_params->dsi.switch_mode_enable);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dsi-dual_dsi_type",
                                &lcm_params->dsi.dual_dsi_type);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dsi-lane_swap_en",
                                &lcm_params->dsi.lane_swap_en);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dsi-lane_swap0",
                                &(lcm_params->dsi.lane_swap[0][0]));
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dsi-lane_swap1",
                                &(lcm_params->dsi.lane_swap[1][0]));
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-dsi-vertical_vfp_lp",
                                &lcm_params->dsi.vertical_vfp_lp);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-physical_width",
                                &lcm_params->physical_width);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-physical_height",
                                &lcm_params->physical_height);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-od_table_size",
                                &lcm_params->od_table_size);
    disp_fdt_getprop_u32_array(node_offset, "lcm_params-od_table",
                                &lcm_params->od_table);
}
    ...
    if (len <= 0) {
        ...
        for (i = 0; i < BACKLIGHT_SIZE; i++) {
            ...
            case LCM_FUNC_CMD:
                ...
                case LCM_UTIL_WRITE_CMD_V1:
                    memcpy(&(lcm_dts->backlight[i].data_t5), tmp+3,
            ...
            if (plcm_name == NULL) {
                ...
                for (i = 0; i < _lcm_count(); i++) {
                    ...
                    if (lcm_id == LCM_INTERFACE_NOTDEFINED ||
                            (lcm_id != LCM_INTERFACE_NOTDEFINED && plcm->lcm_if_id == lcm_id)) {
                        ...
                        if (lcm_drv->compare_id != NULL) {
                            if (lcm_drv->compare_id() != 0) {
                                ...
                                target_fps = disp_lcm_get_dts_u32(g_fdt, "/dsi", "switch_fps");
                                if (target_fps > 0) {
                                    if (hlcm_param.dsi.fps != target_fps) {
                                        DISPMSG("lcm:%s found fps:%u didn't match tgt fps:%u\n",
