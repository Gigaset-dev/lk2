...
#define DISPSYS_DITHER_BASE             DISP_DITHER0_BASE
...
#define DISPSYS_CCORR_BASE              DISP_CCORR0_BASE
#define DISPSYS_CONFIG_BASE             MMSYS_CONFIG_BASE
#define DISPSYS_POSTMASK_BASE            DISP_POSTMASK0_BASE
...
#define EN_FLD_RDMA_READ_WRK   REG_FLD(1, 1)
#define EN_FLD_RDMA_BYPASS_SHADOW   REG_FLD(1, 2)
