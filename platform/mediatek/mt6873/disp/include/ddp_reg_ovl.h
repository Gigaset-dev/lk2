...
#define DISP_REG_OVL_EN                            DISP_OVL0_OVL_EN
    ...
    #define EN_FLD_OVL_READ_WRK                OVL_EN_FLD_READ_WRK
    #define EN_FLD_OVL_BYPASS_SHADOW                OVL_EN_FLD_BYPASS_SHADOW
...
#define DISP_REG_OVL_RDMA0_MEM_GMC_SETTING                DISP_OVL0_OVL_RDMA0_MEM_GMC_SETTING1
    #define FLD_OVL_RDMA_MEM_GMC_ULTRA_THRESHOLD                 \
                             OVL_RDMA0_MEM_GMC_SETTING1_FLD_RDMA0_ULTRA_THRESHOLD
    #define FLD_OVL_RDMA_MEM_GMC_PRE_ULTRA_THRESHOLD             \
                             OVL_RDMA0_MEM_GMC_SETTING1_FLD_RDMA0_PRE_ULTRA_THRESHOLD
    #define FLD_OVL_RDMA_MEM_GMC_ULTRA_THRESHOLD_HIGH_OFS         \
                             OVL_RDMA0_MEM_GMC_SETTING1_FLD_RDMA0_ULTRA_THRESHOLD_HIGH_OFS
    #define FLD_OVL_RDMA_MEM_GMC_PRE_ULTRA_THRESHOLD_HIGH_OFS     \
                             OVL_RDMA0_MEM_GMC_SETTING1_FLD_RDMA0_PRE_ULTRA_THRESHOLD_HIGH_OFS
