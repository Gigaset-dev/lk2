...
//#endif
    ...
    DISP_MODULE_DITHER0_VIRTUAL0, DISP_MODULE_DSC_VIRTUAL0, DISP_MODULE_DSC,
...
int primary_disp_dsc_right_module_list[DDP_ENING_NUM] = {
    ...
    DISP_MODULE_POSTMASK1, DISP_MODULE_DITHER1, DISP_MODULE_DITHER1_VIRTUAL0,
    DISP_MODULE_DSC_VIRTUAL1, DISP_MODULE_DSC,
    DISP_MODULE_DSI0,
    -1,
};
...
static struct mout_t mout_map[] = {
    ...
    {DISP_MODULE_DITHER0,
        {{DISP_MODULE_DSI0, 1 << 0},
         {DISP_MODULE_WDMA0, 1 << 1},
         {DISP_MODULE_DSI1, 1 << 2},
         {DISP_MODULE_DITHER0_VIRTUAL0, 1 << 3}, {-1, 0} },
        0, 0},
    ...
    {DISP_MODULE_DITHER1,
        {{DISP_MODULE_DSI1, 1 << 0},
         {DISP_MODULE_WDMA1, 1 << 1},
         {DISP_MODULE_DITHER1_VIRTUAL0, 1 << 2}, {-1, 0} },
        0, 0},
...
static struct sel_t sel_out_map[] = {
    ...
    /* DISP_DSC_WRAP_SOUT_SEL */
    {DISP_MODULE_DSC, {DISP_MODULE_DSI0, -1}, 0, 0},

    /* DISP_DSI0_DSC_WRAP_SOUT_SEL */
    {DISP_MODULE_DSC_VIRTUAL0, {DISP_MODULE_UNKNOWN,
        DISP_MODULE_DSC, -1}, 0, 0},

    /* DISP_PQ0_SOUT_SEL */
    {DISP_MODULE_DITHER0_VIRTUAL0, {DISP_MODULE_UNKNOWN,
        DISP_MODULE_DSC_VIRTUAL0, -1}, 0, 0},

    /* DISP_PQ1_SOUT_SEL */
    {DISP_MODULE_DITHER1_VIRTUAL0, {DISP_MODULE_UNKNOWN,
        DISP_MODULE_DSC_VIRTUAL1, -1}, 0, 0},
};
...
static struct sel_t sel_in_map[] = {
    ...
    {DISP_MODULE_DSI0, {DISP_MODULE_RDMA0_VIRTUAL0,
     DISP_MODULE_DITHER0, DISP_MODULE_UNKNOWN, DISP_MODULE_DSC, -1}, 0, 0},
    ...
    /* DISP_REG_CONFIG_DISP_OVL1_2L_BGOUT_SOUT_SEL */
    {DISP_MODULE_OVL1, {DISP_MODULE_OVL1_2L, DISP_MODULE_UNKNOWN,
     -1}, 0, 0},
    ...
    /* DISP_RDMA4_PQ0_MERGE0_SEL_IN */
    {DISP_MODULE_DSC_VIRTUAL0, {DISP_MODULE_RDMA4,
     DISP_MODULE_DITHER0_VIRTUAL0, -1}, 0, 0},

    /* DISP_RDMA5_PQ1_SEL_IN */
    {DISP_MODULE_DSC_VIRTUAL1, {DISP_MODULE_RDMA5,
     DISP_MODULE_DITHER1_VIRTUAL0, -1}, 0, 0},
};
...
int ddp_path_init(void)
{
    ...
    /* mout */
    mout_map[0].reg = (unsigned long *)DISP_REG_CONFIG_DISP_TOVL0_OUT0_MOUT_EN;
    mout_map[1].reg = (unsigned long *)DISP_REG_CONFIG_DISP_TOVL0_OUT1_MOUT_EN;
    ...
    mout_map[4].reg = (unsigned long *)DISP_REG_CONFIG_DISP_TOVL1_OUT0_MOUT_EN;
    mout_map[5].reg = (unsigned long *)DISP_REG_CONFIG_DISP_TOVL1_OUT1_MOUT_EN;
    mout_map[6].reg = (unsigned long *)DISP_REG_CONFIG_DISP_RSZ1_MOUT_EN;
    mout_map[7].reg = (unsigned long *)DISP_REG_CONFIG_DISP_DITHER1_MOUT_EN;
    mout_map[8].reg = (unsigned long *)DISP_REG_CONFIG_DISP_OVL2_2L_OUT0_MOUT_EN;
    mout_map[9].reg = (unsigned long *)DISP_REG_CONFIG_DISP_OVL3_2L_OUT0_MOUT_EN;
    ...
    sel_out_map[12].reg =
        (unsigned long *)DISP_REG_CONFIG_DISP_DSC_WRAP_SOUT_SEL;
    sel_out_map[13].reg =
        (unsigned long *)DISP_REG_CONFIG_DISP_DSI0_DSC_WRAP_SOUT_SEL;
    sel_out_map[14].reg =
        (unsigned long *)DISP_REG_CONFIG_DISP_PQ0_SOUT_SEL;
    sel_out_map[15].reg =
        (unsigned long *)DISP_REG_CONFIG_DISP_PQ1_SOUT_SEL;
    ...
    sel_in_map[13].reg =
        (unsigned long *)DISP_REG_CONFIG_DISP_OVL1_2L_BGOUT_SOUT_SEL;
    sel_in_map[14].reg =
    ...
    sel_in_map[24].reg =
        (unsigned long *)DISP_REG_CONFIG_DISP_RDMA4_PQ0_MERGE0_SEL_IN;
    sel_in_map[25].reg =
        (unsigned long *)DISP_REG_CONFIG_DISP_RDMA5_PQ1_SEL_IN;
...
static struct module_map_t module_mutex_map[DISP_MODULE_NUM] = {
    ...
    {DISP_MODULE_DITHER0_VIRTUAL0, -1, 0},
...
int ddp_path_top_clock_on(void)
{
    ...
    DISP_REG_SET(NULL, DISP_REG_CONFIG_MMSYS_CG_CLR0, 0xFFFF3FFF);
    DISP_REG_SET(NULL, DISP_REG_CONFIG_MMSYS_CG_CLR1, 0xFFFFF3FF);
