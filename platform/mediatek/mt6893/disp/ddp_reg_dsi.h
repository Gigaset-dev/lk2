...
struct DSI_REGS {
    ...
    u32 rsv_0120[3];    /* 0124..012c */
    struct DSI_VM_CMD_CON_REG DSI_VM_CMD_CON;    /* 0130 */
    u32 DSI_VM_CMD_DATA0;    /* 0134 */
    u32 DSI_VM_CMD_DATA4;    /* 0138 */
    u32 DSI_VM_CMD_DATA8;    /* 013C */
    u32 DSI_VM_CMD_DATAC;    /* 0140 */
    ...
    u32 DSI_VM_CMD_DATA10;    /* 00180 */
    u32 DSI_VM_CMD_DATA14;    /* 00184 */
    u32 DSI_VM_CMD_DATA18;    /* 00188 */
    u32 DSI_VM_CMD_DATA1C;    /* 0018C */
...
struct DSI_REGS_TYPE {
    ...
    u32 rsv_0120[4];    /* 0120..012c */
    u32 DSI_VM_CMD_CON;    /* 0130 */
    u32 DSI_VM_CMD_DATA0;    /* 0134 */
    u32 DSI_VM_CMD_DATA4;    /* 0138 */
    u32 DSI_VM_CMD_DATA8;    /* 013C */
    u32 DSI_VM_CMD_DATAC;    /* 0140 */
    ...
    u32 DSI_VM_CMD_DATA18;    /* 00188 */
    u32 DSI_VM_CMD_DATA1C;    /* 0018C */
    u32 DSI_SHADOW_DEBUG;    /* 0190 */
    u32 DSI_SHADOW_STA;    /* 0194 */
};
