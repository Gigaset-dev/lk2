...
extern struct DISP_MUTEX_REGS *g_DISP1_MUTEX_BASE;

#define DISP_MUTEX_BASE                         (g_DISP_MUTEX_BASE)
#define DISP1_MUTEX_BASE                        (g_DISP1_MUTEX_BASE)

#define DISP0_MUTEX_INTEN                       (addr_t)(&DISP_MUTEX_BASE->DISP_MUTEX_INTEN) // 1000
// 1004
#define DISP0_MUTEX_INTSTA                      (addr_t)(&DISP_MUTEX_BASE->DISP_MUTEX_INTSTA)
#define DISP0_MUTEX_CFG                         (addr_t)(&DISP_MUTEX_BASE->DISP_MUTEX_CFG) // 1008
#define DISP0_MUTEX0_EN                         (addr_t)(&DISP_MUTEX_BASE->DISP_MUTEX0_EN) // 6020
#define DISP0_MUTEX0_RST                        (addr_t)(&DISP_MUTEX_BASE->DISP_MUTEX0_RST) // 6028
#define DISP0_MUTEX0_CTL                        (addr_t)(&DISP_MUTEX_BASE->DISP_MUTEX0_CTL) // 602C
#define DISP0_MUTEX0_MOD0                       (addr_t)(&DISP_MUTEX_BASE->DISP_MUTEX0_MOD0) // 6030
#define DISP0_MUTEX0_MOD1                       (addr_t)(&DISP_MUTEX_BASE->DISP_MUTEX0_MOD1) // 6034
#define DISP0_MUTEX1_EN                         (addr_t)(&DISP_MUTEX_BASE->DISP_MUTEX1_EN) // 6040
#define DISP0_MUTEX1_RST                        (addr_t)(&DISP_MUTEX_BASE->DISP_MUTEX1_RST) // 6048
#define DISP0_MUTEX1_CTL                        (addr_t)(&DISP_MUTEX_BASE->DISP_MUTEX1_CTL) // 604C
#define DISP0_MUTEX1_MOD0                       (addr_t)(&DISP_MUTEX_BASE->DISP_MUTEX1_MOD0) // 6050
#define DISP0_MUTEX2_EN                         (addr_t)(&DISP_MUTEX_BASE->DISP_MUTEX2_EN) // 6060
#define DISP0_MUTEX2_RST                        (addr_t)(&DISP_MUTEX_BASE->DISP_MUTEX2_RST) // 6068
#define DISP0_MUTEX2_CTL                        (addr_t)(&DISP_MUTEX_BASE->DISP_MUTEX2_CTL) // 606C
#define DISP0_MUTEX2_MOD0                       (addr_t)(&DISP_MUTEX_BASE->DISP_MUTEX2_MOD0) // 6070
#define DISP0_MUTEX3_EN                         (addr_t)(&DISP_MUTEX_BASE->DISP_MUTEX3_EN) // 6080
#define DISP0_MUTEX3_RST                        (addr_t)(&DISP_MUTEX_BASE->DISP_MUTEX3_RST) // 6088
#define DISP0_MUTEX3_CTL                        (addr_t)(&DISP_MUTEX_BASE->DISP_MUTEX3_CTL) // 608C
#define DISP0_MUTEX3_MOD0                       (addr_t)(&DISP_MUTEX_BASE->DISP_MUTEX3_MOD0) // 6090
#define DISP0_MUTEX4_EN                         (addr_t)(&DISP_MUTEX_BASE->DISP_MUTEX4_EN) // 60A0
#define DISP0_MUTEX4_RST                        (addr_t)(&DISP_MUTEX_BASE->DISP_MUTEX4_RST) // 60A8
#define DISP0_MUTEX4_CTL                        (addr_t)(&DISP_MUTEX_BASE->DISP_MUTEX4_CTL) // 60AC
#define DISP0_MUTEX4_MOD0                       (addr_t)(&DISP_MUTEX_BASE->DISP_MUTEX4_MOD0) // 60B0
#define DISP0_MUTEX5_EN                         (addr_t)(&DISP_MUTEX_BASE->DISP_MUTEX5_EN) // 60C0
#define DISP0_MUTEX5_RST                        (addr_t)(&DISP_MUTEX_BASE->DISP_MUTEX5_RST) // 60C8
#define DISP0_MUTEX5_CTL                        (addr_t)(&DISP_MUTEX_BASE->DISP_MUTEX5_CTL) // 60CC
#define DISP0_MUTEX5_MOD0                       (addr_t)(&DISP_MUTEX_BASE->DISP_MUTEX5_MOD0) // 60D0
#define DISP0_MUTEX6_EN                         (addr_t)(&DISP_MUTEX_BASE->DISP_MUTEX6_EN) // 60E0
#define DISP0_MUTEX6_RST                        (addr_t)(&DISP_MUTEX_BASE->DISP_MUTEX6_RST) // 60E8
#define DISP0_MUTEX6_CTL                        (addr_t)(&DISP_MUTEX_BASE->DISP_MUTEX6_CTL) // 60EC
#define DISP0_MUTEX6_MOD0                       (addr_t)(&DISP_MUTEX_BASE->DISP_MUTEX6_MOD0) // 60F0
#define DISP0_MUTEX7_EN                         (addr_t)(&DISP_MUTEX_BASE->DISP_MUTEX7_EN) // 6100
#define DISP0_MUTEX7_RST                        (addr_t)(&DISP_MUTEX_BASE->DISP_MUTEX7_RST) // 6108
#define DISP0_MUTEX7_CTL                        (addr_t)(&DISP_MUTEX_BASE->DISP_MUTEX7_CTL) // 610C
#define DISP0_MUTEX7_MOD0                       (addr_t)(&DISP_MUTEX_BASE->DISP_MUTEX7_MOD0) // 6110
#define DISP0_MUTEX8_EN                         (addr_t)(&DISP_MUTEX_BASE->DISP_MUTEX8_EN) // 6120
#define DISP0_MUTEX8_RST                        (addr_t)(&DISP_MUTEX_BASE->DISP_MUTEX8_RST) // 6128
#define DISP0_MUTEX8_CTL                        (addr_t)(&DISP_MUTEX_BASE->DISP_MUTEX8_CTL) // 612C
#define DISP0_MUTEX8_MOD0                       (addr_t)(&DISP_MUTEX_BASE->DISP_MUTEX8_MOD0) // 6130
#define DISP0_MUTEX9_EN                         (addr_t)(&DISP_MUTEX_BASE->DISP_MUTEX9_EN) // 6140
#define DISP0_MUTEX9_RST                        (addr_t)(&DISP_MUTEX_BASE->DISP_MUTEX9_RST) // 6148
#define DISP0_MUTEX9_CTL                        (addr_t)(&DISP_MUTEX_BASE->DISP_MUTEX9_CTL) // 614C
#define DISP0_MUTEX9_MOD0                       (addr_t)(&DISP_MUTEX_BASE->DISP_MUTEX9_MOD0) // 6150
#define DEBUG_OUT_SEL                           (addr_t)(&DISP_MUTEX_BASE->DEBUG_OUT_SEL) // 130C

#define DISP1_MUTEX_INTEN                       (addr_t)(&DISP1_MUTEX_BASE->DISP_MUTEX_INTEN)
#define DISP1_MUTEX_INTSTA                      (addr_t)(&DISP1_MUTEX_BASE->DISP_MUTEX_INTSTA)
#define DISP1_MUTEX_CFG                         (addr_t)(&DISP1_MUTEX_BASE->DISP_MUTEX_CFG)
#define DISP1_MUTEX0_EN                         (addr_t)(&DISP1_MUTEX_BASE->DISP_MUTEX0_EN)
#define DISP1_MUTEX0_RST                        (addr_t)(&DISP1_MUTEX_BASE->DISP_MUTEX0_RST)
#define DISP1_MUTEX0_CTL                        (addr_t)(&DISP1_MUTEX_BASE->DISP_MUTEX0_CTL)
#define DISP1_MUTEX0_MOD0                       (addr_t)(&DISP1_MUTEX_BASE->DISP_MUTEX0_MOD0)
#define DISP1_MUTEX0_MOD1                       (addr_t)(&DISP1_MUTEX_BASE->DISP_MUTEX0_MOD1)
