...
#define DISP_OVL1_BASE                          (IO_BASE + 0xffffffff)
#define MDP_AAL4_BASE                           (IO_BASE + 0xffffffff)
#define MDP_AAL5_BASE                           (IO_BASE + 0xffffffff)
...
#define DISP_INDEX_OFFSET                       (DISP_OVL0_2L_BASE - OVL0_BASE)
#define DISP_RDMA_INDEX_OFFSET                  (DISP_RDMA1_BASE - DISP_RDMA0_BASE)
#define DISP_TDSHP_INDEX_OFFSET                 (DISP_TDSHP1_BASE - DISP_TDSHP0_BASE)
#define DISP_C3D_INDEX_OFFSET                   (DISP_C3D1_BASE - DISP_C3D0_BASE)
#define DISP_COLOR_INDEX_OFFSET                 (DISP_COLOR1_BASE - DISP_COLOR0_BASE)
#define DISP_CCORR0_1_INDEX_OFFSET              (DISP_CCORR0_1_BASE - DISP_CCORR0_BASE)
#define DISP_CCORR1_INDEX_OFFSET                (DISP_CCORR1_BASE - DISP_CCORR0_BASE)
#define DISP_CCORR1_1_INDEX_OFFSET              (DISP_CCORR1_1_BASE - DISP_CCORR0_BASE)
...
#define DISP_DITHER_INDEX_OFFSET                (DISP_DITHER1_BASE - DISP_DITHER0_BASE)
#define DISP_MDP_AAL_INDEX_OFFSET               (DISP_MDP_AAL1_BASE - DISP_MDP_AAL0_BASE)
#define DISP_POSTMASK_INDEX_OFFSET              (DISP_POSTMASK1_BASE - DISP_POSTMASK0_BASE)
#define DISP_CM_INDEX_OFFSET                    (DISP_CM1_BASE - DISP_CM0_BASE)
#define DISP_SPR_INDEX_OFFSET                   (DISP_SPR1_BASE - DISP_SPR0_BASE)
#define DISP_CHIST_INDEX_OFFSET                 (DISP_CHIST1_BASE - DISP_CHIST0_BASE)
#define DISP1_CHIST_INDEX_OFFSET                (DISP1_CHIST1_BASE - DISP1_CHIST0_BASE)
#define DISP_CM_INDEX_OFFSET                    (DISP_CM1_BASE - DISP_CM0_BASE)
#define DISP_SPR_INDEX_OFFSET                   (DISP_SPR1_BASE - DISP_SPR0_BASE)

#define DISPSYS_OVL_OFFSET                      (DISP1_OVL0_BASE - OVL0_BASE)
#define DISPSYS_RDMA_OFFSET                     (DISP1_RDMA0_BASE - DISP_RDMA0_BASE)

#define SMI_LARB0_SEC_CON                       (IO_BASE_PHY + 0x04021F80)
#define SMI_LARB1_SEC_CON                       (IO_BASE_PHY + 0x04022F80)
#define SMI_LARB20_SEC_CON                      (IO_BASE_PHY + 0x04421F80)
#define SMI_LARB21_SEC_CON                      (IO_BASE_PHY + 0x04422F80)

/* SEC_DISPLAY */
#define DISP_REG_MMSYS_SECURITY_DISABLE2        (IO_BASE_PHY + 0x04000A08)
#define DISP1_REG_MMSYS_SECURITY_DISABLE2       (IO_BASE_PHY + 0x04400A08)


#define DISPSYS_OVL0_BASE                       OVL0_BASE
#define DISPSYS_OVL1_BASE                       DISP_OVL1_BASE
...
#define DISPSYS_C3D1_BASE                       DISP_C3D1_BASE
#define DISPSYS_TDSHP0_BASE                     DISP_TDSHP0_BASE
#define DISPSYS_TDSHP1_BASE                     DISP_TDSHP1_BASE
#define DISPSYS_COLOR0_BASE                     DISP_COLOR0_BASE
#define DISPSYS_COLOR1_BASE                     DISP_COLOR1_BASE
#define DISPSYS_AAL0_BASE                       DISP_AAL0_BASE
#define DISPSYS_AAL1_BASE                       DISP_AAL1_BASE
#define DISPSYS_MDP_AAL0_BASE                   DISP_MDP_AAL0_BASE
#define DISPSYS_MDP_AAL1_BASE                   DISP_MDP_AAL1_BASE
...
#define DISPSYS_CM1_BASE                        DISP_CM1_BASE
#define DISPSYS_SPR0_BASE                       DISP_SPR0_BASE
#define DISPSYS_SPR1_BASE                       DISP_SPR1_BASE
...
#define DISPSYS_DITHER1_BASE                    DISP_DITHER1_BASE
...
#define DISPSYS_POSTMASK1_BASE                  DISP_POSTMASK1_BASE
#define DISPSYS_DSC_BASE                        DISP_DSC_BASE

#define DISPSYS1_MUTEX_BASE                     MM1_MUTEX_BASE
#define DISPSYS1_CONFIG_BASE                    MMSYS1_CONFIG_BASE
#define DISPSYS1_OVL0_BASE                      DISP1_OVL0_BASE
#define DISPSYS1_OVL0_2L_BASE                   DISP1_OVL0_2L_BASE
#define DISPSYS1_OVL1_2L_BASE                   DISP1_OVL1_2L_BASE
#define DISPSYS1_RDMA0_BASE                     DISP1_RDMA0_BASE
...
#define DISP_REG_RDMA_MEM_GMC_SETTING_1           (DISPSYS_RDMA0_BASE+0x034)
    #define MEM_GMC_SETTING_1_FLD_ULTRA_THRESHOLD_LOW    REG_FLD_MSB_LSB(13, 0)
    #define MEM_GMC_SETTING_1_FLD_ULTRA_THRESHOLD_HIGH   REG_FLD_MSB_LSB(29, 16)
