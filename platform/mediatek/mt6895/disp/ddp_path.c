...
int primary_disp_dsc_module_list[DDP_ENING_NUM] = {
    DISP_MODULE_OVL1_2L, DISP_MODULE_OVL0, DISP_MODULE_OVL0_VIRTUAL0,
...
int primary_disp_dsc_right_module_list[DDP_ENING_NUM] = {
    DISP1_MODULE_OVL1_2L, DISP1_MODULE_OVL0, DISP1_MODULE_OVL0_VIRTUAL0,
...
static void ddp_print_scenario(enum DDP_SCENARIO_ENUM scenario)
{
    ...
    int num = ddp_get_module_num(scenario), len = 0;
