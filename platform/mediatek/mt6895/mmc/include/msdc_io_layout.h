...
#else
static inline void msdc_set_driving_by_id(u32 id, struct msdc_cust *msdc_cap) {}
static inline void msdc_set_ies_by_id(u32 id, int set_ies) {}
static inline void msdc_set_sr_by_id(u32 id, int clk, int cmd, int dat, int rst, int ds) {}
static inline void msdc_set_smt_by_id(u32 id, int set_smt) {}
static inline void msdc_set_tdsel_by_id(u32 id, u32 flag, u32 value) {}
static inline void msdc_set_rdsel_by_id(u32 id, u32 flag, u32 value) {}
static inline void msdc_get_tdsel_by_id(u32 id, u32 *value) {}
static inline void msdc_get_rdsel_by_id(u32 id, u32 *value) {}
static inline void msdc_dump_clock_sts(struct mmc_host *host) {}
static inline void msdc_dump_ldo_sts(struct mmc_host *host) {}
static inline void msdc_dump_padctl_by_id(u32 id) {}
static inline void msdc_pin_config_by_id(u32 id, u32 mode) {}
static inline void msdc_set_pin_mode(struct mmc_host *host) {}
static inline void msdc_set_tdsel_wrap(struct mmc_host *host) {}
static inline void msdc_set_rdsel_wrap(struct mmc_host *host) {}
static inline void msdc_gpio_and_pad_init(struct mmc_host *host) {}
static inline void msdc_hs400_ds_delay(struct mmc_host *host) {}
static inline int EFUSE_IS_EMMC_BOOT_BUS_WIDTH_8BIT(void) { return 0; }
#endif
...
#define MSDC_PB1_DEFAULT        0xFFA04309
