...
#define POWER_ON                 1
#define POWER_DOWN              0
#define PWRCON_STATUS            (0x1 << 30)
#define PWRCON_STATUS_2ND        (0x1 << 31)

struct mtk_infracfg_ao_regs {
    uint32_t reserved0[780];
    uint32_t mmsys_protect_en_2;
    uint32_t mmsys_protect_en_2_set;
    uint32_t mmsys_protect_en_2_clr;
    uint32_t mmsys_protect_rdy_sta_2;
    ...
    uint32_t emisys_protect_en_1;
    uint32_t emisys_protect_en_1_set;
    uint32_t emisys_protect_en_1_clr;
    uint32_t emisys_protect_rdy_sta_1;
...
STATIC_ASSERT(__offsetof(struct mtk_infracfg_ao_regs, mmsys_protect_en_2)
        == 0x0C30);
STATIC_ASSERT(__offsetof(struct mtk_infracfg_ao_regs, mmsys_protect_en_2_set)
        == 0x0C34);
STATIC_ASSERT(__offsetof(struct mtk_infracfg_ao_regs, mmsys_protect_en_2_clr)
        == 0x0C38);
STATIC_ASSERT(__offsetof(struct mtk_infracfg_ao_regs, mmsys_protect_rdy_sta_2)
        == 0x0C3C);
...
STATIC_ASSERT(__offsetof(struct mtk_infracfg_ao_regs, emisys_protect_rdy_sta_0)
        == 0x0C6C);
STATIC_ASSERT(__offsetof(struct mtk_infracfg_ao_regs, emisys_protect_en_1)
        == 0x0C70);
STATIC_ASSERT(__offsetof(struct mtk_infracfg_ao_regs, emisys_protect_en_1_set)
        == 0x0C74);
STATIC_ASSERT(__offsetof(struct mtk_infracfg_ao_regs, emisys_protect_en_1_clr)
        == 0x0C78);
STATIC_ASSERT(__offsetof(struct mtk_infracfg_ao_regs, emisys_protect_rdy_sta_1)
        == 0x0C7C);
...
struct mtk_gpu_eb_rpc_bus_regs {
    uint32_t reserved0[16];
    uint32_t mfg_gpu_eb_spm_rpc_slp_protecten_set;
    uint32_t mfg_gpu_eb_spm_rpc_slp_protecten_clr;
    uint32_t mfg_gpu_eb_spm_rpc_slp_protecten_sta;
};

static struct mtk_gpu_eb_rpc_bus_regs *const mtk_gpu_eb_rpc_bus = (void *)GPU_EB_RPC_BUS_BASE;

STATIC_ASSERT(__offsetof(struct mtk_gpu_eb_rpc_bus_regs, mfg_gpu_eb_spm_rpc_slp_protecten_set)
        == 0x0040);
STATIC_ASSERT(__offsetof(struct mtk_gpu_eb_rpc_bus_regs, mfg_gpu_eb_spm_rpc_slp_protecten_clr)
        == 0x0044);
STATIC_ASSERT(__offsetof(struct mtk_gpu_eb_rpc_bus_regs, mfg_gpu_eb_spm_rpc_slp_protecten_sta)
        == 0x0048);
...
STATIC_ASSERT(__offsetof(struct mtk_spm_regs, mfg1_pwr_con)
        == 0xEBC);
STATIC_ASSERT(__offsetof(struct mtk_spm_regs, emi_hre_sram_con)
        == 0xF08);
...
enum {
    ...
    MM_PROC_L2SRAM_PDN1 = 1U << 23,
    MM_PROC_L2SRAM_PDN2 = 1U << 22,
    MM_PROC_L2SRAM_PDN3 = 1U << 21,
    MM_PROC_L2SRAM_PDN4 = 1U << 20,
    MM_PROC_L2SRAM_SLP_B1 = 1U << 8,
    MM_PROC_L2SRAM_SLP_B2 = 1U << 9,
    MM_PROC_L2SRAM_SLP_B3 = 1U << 10,
    MM_PROC_L2SRAM_SLP_B4 = 1U << 11,
};

enum {
    ADSP_INFRA_PROT_STEP0_0_MASK = ((1U << 18) | (1U << 19) | (1U << 22) |
                                   (1U << 26) | (1U << 27) | (1U << 28) |
                                   (1U << 29) | (1U << 30)),
    ADSP_INFRA_PROT_STEP0_0_ACK_MASK = ((1U << 18) | (1U << 19) | (1U << 22) |
                                   (1U << 26) | (1U << 27) | (1U << 28) |
                                   (1U << 29) | (1U << 30)),
    ADSP_INFRA_PROT_STEP1_0_MASK = 1U << 8,
    ADSP_INFRA_PROT_STEP1_0_ACK_MASK = 1U << 8,
    ADSP_INFRA_PROT_STEP2_0_MASK = ((1U << 20) | (1U << 21) | (1U << 25) | (1U << 31)),
    ADSP_INFRA_PROT_STEP2_0_ACK_MASK = ((1U << 20) | (1U << 21) | (1U << 25) | (1U << 31)),
    ADSP_TOP_PROT_STEP0_0_MASK = ((1U << 14) | (1U << 15) | (1U << 16) | (1U << 17)),
    ADSP_TOP_PROT_STEP0_0_ACK_MASK = ((1U << 14) | (1U << 15) | (1U << 16) | (1U << 17)),
    ADSP_TOP_PROT_STEP1_0_MASK = ((1U << 23) | (1U << 24)),
    ADSP_TOP_PROT_STEP1_0_ACK_MASK = ((1U << 23) | (1U << 24)),
    MD1_PROT_STEP0_0_MASK = 1U << 9,
    MD1_PROT_STEP0_0_ACK_MASK = 1U << 9,
    MD1_PROT_STEP1_0_MASK = 1U << 28,
    MD1_PROT_STEP1_0_ACK_MASK = 1U << 28,
    MD1_PROT_STEP2_0_MASK = ((1U << 17) | (1U << 16)),
    MD1_PROT_STEP2_0_ACK_MASK = ((1U << 17) | (1U << 16)),
    MFG0_PROT_STEP0_0_MASK = 1U << 4,
    MFG0_PROT_STEP0_0_ACK_MASK = 1U << 4,
    MFG0_PROT_STEP1_0_MASK = 1U << 9,
    MFG0_PROT_STEP1_0_ACK_MASK = 1U << 9,
    MFG1_PROT_STEP0_0_MASK = ((1U << 0) | (1U << 1) | (1U << 2) | (1U << 3)),
    MFG1_PROT_STEP0_0_ACK_MASK = ((1U << 0) | (1U << 1) | (1U << 2) | (1U << 3)),
    MFG1_PROT_STEP1_0_MASK = ((1U << 16) | (1U << 17) | (1U << 18) | (1U << 19)),
    MFG1_PROT_STEP1_0_ACK_MASK = ((1U << 16) | (1U << 17) | (1U << 18) | (1U << 19)),
    MFG1_PROT_STEP2_0_MASK = ((1U << 19) | (1U << 18)),
    MFG1_PROT_STEP2_0_ACK_MASK = ((1U << 19) | (1U << 18)),
    MFG1_PROT_STEP3_0_MASK = ((1U << 19) | (1U << 18)),
    MFG1_PROT_STEP3_0_ACK_MASK = ((1U << 19) | (1U << 18)),
    MM_PROC_PROT_STEP0_0_MASK = ((1U << 10) | (1U << 11)),
    MM_PROC_PROT_STEP0_0_ACK_MASK = ((1U << 10) | (1U << 11)),
    MM_PROC_PROT_STEP1_0_MASK = ((1U << 12) | (1U << 13)),
    MM_PROC_PROT_STEP1_0_ACK_MASK = ((1U << 12) | (1U << 13)),
    MM_PROC_PROT_STEP2_0_MASK = ((1U << 15) | (1U << 17)),
    MM_PROC_PROT_STEP2_0_ACK_MASK = ((1U << 15) | (1U << 17)),
};
...
static void ram_console_update(void)
{
    ...
    if (loop_cnt > 100000 && !log_dump) {
        log_dump = true;
        dprintf(CRITICAL, "mmsys_protect_en_2=%08x\n",
                read32(&mtk_infracfg_ao->mmsys_protect_en_2));
        dprintf(CRITICAL, "mmsys_protect_rdy_sta_2=%08x\n",
                read32(&mtk_infracfg_ao->mmsys_protect_rdy_sta_2));
        ...
        dprintf(CRITICAL, "emisys_protect_en_1=%08x\n",
                read32(&mtk_infracfg_ao->emisys_protect_en_1));
        dprintf(CRITICAL, "emisys_protect_rdy_sta_1=%08x\n",
                read32(&mtk_infracfg_ao->emisys_protect_rdy_sta_1));
        ...
        dprintf(CRITICAL, "mfg_gpu_eb_spm_rpc_slp_protecten_set=%08x\n",
                read32(&mtk_gpu_eb_rpc_bus->mfg_gpu_eb_spm_rpc_slp_protecten_set));
        dprintf(CRITICAL, "mfg_gpu_eb_spm_rpc_slp_protecten_sta=%08x\n",
                read32(&mtk_gpu_eb_rpc_bus->mfg_gpu_eb_spm_rpc_slp_protecten_sta));
        ...
        dprintf(CRITICAL, "emi_hre_sram_con=%08x\n",
                read32(&mtk_spm->emi_hre_sram_con));
...
void spm_mtcmos_ctrl_md1_enable(void)
{
    ...
    INCREASE_STEPS;
    #endif
    write32(&mtk_infracfg_ao->emisys_protect_en_0_clr, MD1_PROT_STEP2_0_MASK);
    write32(&mtk_infracfg_ao->infrasys_protect_en_0_clr, MD1_PROT_STEP1_0_MASK);
...
void spm_mtcmos_ctrl_md1_disable(void)
{
    ...
    INCREASE_STEPS;
    #endif
    write32(&mtk_infracfg_ao->infrasys_protect_en_0_set, MD1_PROT_STEP1_0_MASK);
    #ifndef IGNORE_MTCMOS_CHECK
    ...
    INCREASE_STEPS;
    #endif
    write32(&mtk_infracfg_ao->emisys_protect_en_0_set, MD1_PROT_STEP2_0_MASK);
    #ifndef IGNORE_MTCMOS_CHECK
...
void spm_mtcmos_ctrl_audio_enable(void)
{
    ...
    #ifndef IGNORE_MTCMOS_CHECK
    while (((read32(&mtk_spm->audio_pwr_con) & PWRCON_STATUS) != PWRCON_STATUS)
            || ((read32(&mtk_spm->audio_pwr_con) & PWRCON_STATUS_2ND) != PWRCON_STATUS_2ND))
        ram_console_update();
...
void spm_mtcmos_ctrl_audio_disable(void)
{
    ...
    #ifndef IGNORE_MTCMOS_CHECK
    while ((read32(&mtk_spm->audio_pwr_con) & PWRCON_STATUS)
            || (read32(&mtk_spm->audio_pwr_con) & PWRCON_STATUS_2ND))
        ram_console_update();
...
void spm_mtcmos_ctrl_adsp_top_shutdown_enable(void)
{
    ...
    #ifndef IGNORE_MTCMOS_CHECK
    while (((read32(&mtk_spm->adsp_top_pwr_con) & PWRCON_STATUS) != PWRCON_STATUS)
            || ((read32(&mtk_spm->adsp_top_pwr_con) & PWRCON_STATUS_2ND) != PWRCON_STATUS_2ND))
        ram_console_update();
...
void spm_mtcmos_ctrl_adsp_top_shutdown_disable(void)
{
    ...
    #ifndef IGNORE_MTCMOS_CHECK
    while ((read32(&mtk_spm->adsp_top_pwr_con) & PWRCON_STATUS)
            || (read32(&mtk_spm->adsp_top_pwr_con) & PWRCON_STATUS_2ND))
        ram_console_update();
...
void spm_mtcmos_ctrl_adsp_infra_enable(void)
{
    ...
    #ifndef IGNORE_MTCMOS_CHECK
    while (((read32(&mtk_spm->adsp_infra_pwr_con) & PWRCON_STATUS) != PWRCON_STATUS)
            || ((read32(&mtk_spm->adsp_infra_pwr_con) & PWRCON_STATUS_2ND) != PWRCON_STATUS_2ND))
        ram_console_update();
...
void spm_mtcmos_ctrl_adsp_infra_disable(void)
{
    ...
    #ifndef IGNORE_MTCMOS_CHECK
    while ((read32(&mtk_spm->adsp_infra_pwr_con) & PWRCON_STATUS)
            || (read32(&mtk_spm->adsp_infra_pwr_con) & PWRCON_STATUS_2ND))
        ram_console_update();
...
void spm_mtcmos_ctrl_adsp_ao_enable(void)
{
    ...
    #ifndef IGNORE_MTCMOS_CHECK
    while (((read32(&mtk_spm->adsp_ao_pwr_con) & PWRCON_STATUS) != PWRCON_STATUS)
            || ((read32(&mtk_spm->adsp_ao_pwr_con) & PWRCON_STATUS_2ND) != PWRCON_STATUS_2ND))
        ram_console_update();
...
void spm_mtcmos_ctrl_adsp_ao_disable(void)
{
    ...
    #ifndef IGNORE_MTCMOS_CHECK
    while ((read32(&mtk_spm->adsp_ao_pwr_con) & PWRCON_STATUS)
            || (read32(&mtk_spm->adsp_ao_pwr_con) & PWRCON_STATUS_2ND))
        ram_console_update();
...
void spm_mtcmos_ctrl_mm_proc_shutdown_enable(void)
{
    ...
    #ifndef IGNORE_MTCMOS_CHECK
    while (((read32(&mtk_spm->mm_proc_pwr_con) & PWRCON_STATUS) != PWRCON_STATUS)
            || ((read32(&mtk_spm->mm_proc_pwr_con) & PWRCON_STATUS_2ND) != PWRCON_STATUS_2ND))
        ram_console_update();
    ...
    clrbits32(&mtk_spm->emi_hre_sram_con, MM_PROC_L2SRAM_PDN4);
    clrbits32(&mtk_spm->emi_hre_sram_con, MM_PROC_L2SRAM_PDN3);
    clrbits32(&mtk_spm->emi_hre_sram_con, MM_PROC_L2SRAM_PDN2);
    clrbits32(&mtk_spm->emi_hre_sram_con, MM_PROC_L2SRAM_PDN1);
    ...
    write32(&mtk_infracfg_ao->mmsys_protect_en_2_clr, MM_PROC_PROT_STEP2_0_MASK);
...
void spm_mtcmos_ctrl_mm_proc_shutdown_disable(void)
{
    ...
    INCREASE_STEPS;
    #endif
    write32(&mtk_infracfg_ao->mmsys_protect_en_2_set, MM_PROC_PROT_STEP2_0_MASK);
    #ifndef IGNORE_MTCMOS_CHECK
    while ((read32(&mtk_infracfg_ao->mmsys_protect_rdy_sta_2)
    ...
    setbits32(&mtk_spm->emi_hre_sram_con, MM_PROC_L2SRAM_PDN1);
    setbits32(&mtk_spm->emi_hre_sram_con, MM_PROC_L2SRAM_PDN2);
    setbits32(&mtk_spm->emi_hre_sram_con, MM_PROC_L2SRAM_PDN3);
    setbits32(&mtk_spm->emi_hre_sram_con, MM_PROC_L2SRAM_PDN4);
...
void spm_mtcmos_ctrl_mm_proc_dormant_enable(void)
{
    ...
    clrbits32(&mtk_spm->mm_proc_pwr_con, PWR_ISO);
    setbits32(&mtk_spm->mm_proc_pwr_con, PWR_RST_B);
    setbits32(&mtk_spm->emi_hre_sram_con, MM_PROC_L2SRAM_SLP_B4);
    setbits32(&mtk_spm->emi_hre_sram_con, MM_PROC_L2SRAM_SLP_B3);
    setbits32(&mtk_spm->emi_hre_sram_con, MM_PROC_L2SRAM_SLP_B2);
    setbits32(&mtk_spm->emi_hre_sram_con, MM_PROC_L2SRAM_SLP_B1);
...
void spm_mtcmos_ctrl_mm_proc_dormant_disable(void)
{
    ...
    setbits32(&mtk_spm->mm_proc_pwr_con, SRAM_CKISO);
    clrbits32(&mtk_spm->mm_proc_pwr_con, SRAM_ISOINT_B);
    clrbits32(&mtk_spm->emi_hre_sram_con, MM_PROC_L2SRAM_SLP_B1);
    clrbits32(&mtk_spm->emi_hre_sram_con, MM_PROC_L2SRAM_SLP_B2);
    clrbits32(&mtk_spm->emi_hre_sram_con, MM_PROC_L2SRAM_SLP_B3);
    clrbits32(&mtk_spm->emi_hre_sram_con, MM_PROC_L2SRAM_SLP_B4);
    ...
    clrbits32(&mtk_spm->mm_proc_pwr_con, PWR_ON_2ND);
    #ifndef IGNORE_MTCMOS_CHECK
    while ((read32(&mtk_spm->mm_proc_pwr_con) & PWRCON_STATUS)
            || (read32(&mtk_spm->mm_proc_pwr_con) & PWRCON_STATUS_2ND))
        ram_console_update();
...
void spm_mtcmos_ctrl_mfg0_shutdown_enable(void)
{
    ...
    #ifndef IGNORE_MTCMOS_CHECK
    while (((read32(&mtk_spm->mfg0_pwr_con) & PWRCON_STATUS) != PWRCON_STATUS)
            || ((read32(&mtk_spm->mfg0_pwr_con) & PWRCON_STATUS_2ND) != PWRCON_STATUS_2ND))
        ram_console_update();
...
void spm_mtcmos_ctrl_mfg0_shutdown_disable(void)
{
    ...
    #ifndef IGNORE_MTCMOS_CHECK
    while ((read32(&mtk_spm->mfg0_pwr_con) & PWRCON_STATUS)
            || (read32(&mtk_spm->mfg0_pwr_con) & PWRCON_STATUS_2ND))
        ram_console_update();
...
void spm_mtcmos_ctrl_mfg1_enable(void)
{
    ...
    #ifndef IGNORE_MTCMOS_CHECK
    while (((read32(&mtk_spm->mfg1_pwr_con) & PWRCON_STATUS) != PWRCON_STATUS)
            || ((read32(&mtk_spm->mfg1_pwr_con) & PWRCON_STATUS_2ND) != PWRCON_STATUS_2ND))
        ram_console_update();
    ...
    INCREASE_STEPS;
    #endif
    write32(&mtk_infracfg_ao->emisys_protect_en_1_clr, MFG1_PROT_STEP3_0_MASK);
    write32(&mtk_infracfg_ao->emisys_protect_en_0_clr, MFG1_PROT_STEP2_0_MASK);
    write32(&mtk_gpu_eb_rpc_bus->mfg_gpu_eb_spm_rpc_slp_protecten_clr, MFG1_PROT_STEP1_0_MASK);
...
void spm_mtcmos_ctrl_mfg1_disable(void)
{
    ...
    INCREASE_STEPS;
    #endif
    write32(&mtk_gpu_eb_rpc_bus->mfg_gpu_eb_spm_rpc_slp_protecten_set, MFG1_PROT_STEP1_0_MASK);
    #ifndef IGNORE_MTCMOS_CHECK
    while ((read32(&mtk_gpu_eb_rpc_bus->mfg_gpu_eb_spm_rpc_slp_protecten_sta)
    ...
    INCREASE_STEPS;
    #endif
    write32(&mtk_infracfg_ao->emisys_protect_en_1_set, MFG1_PROT_STEP3_0_MASK);
    #ifndef IGNORE_MTCMOS_CHECK
    while ((read32(&mtk_infracfg_ao->emisys_protect_rdy_sta_1)
    ...
    #ifndef IGNORE_MTCMOS_CHECK
    while ((read32(&mtk_spm->mfg1_pwr_con) & PWRCON_STATUS)
            || (read32(&mtk_spm->mfg1_pwr_con) & PWRCON_STATUS_2ND))
        ram_console_update();
