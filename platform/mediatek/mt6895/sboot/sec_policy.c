...
#define VFY_EN_MASK             (0x1)
#define DL_ALLOW_MASK           (0x2)

#define VFY_DIS_DL_FORBIDDEN    (0x0)
#define VFY_DIS_DL_ALLOW        DL_ALLOW_MASK
#define VFY_EN_DL_FORBIDDEN     VFY_EN_MASK
#define VFY_EN_DL_ALLOW         (VFY_EN_MASK|DL_ALLOW_MASK)

#define SHA256_HASH_SZ          (32)

#define NEED_VERIFY             (1)
#define SKIP_VERIFY             (0)
#define DL_ALLOW                (1)
#define DL_FORBIDDEN            (0)
...
{
    unsigned int i = 0;
    unsigned int num_of_entries = countof(g_policy_map);
...
int sec_get_vfy_policy(const char *part_name)
{
...
int sec_get_dl_policy(const char *part_name)
{
    unsigned int sec_policy = 0;
    unsigned int policy_entry_idx = 0;
