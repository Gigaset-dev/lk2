...
struct lvts_thermal_controller lvts_tscpu_g_tc[LVTS_CONTROLLER_NUM] = {
    [LVTS_MCU_CONTROLLER0] = {/*(MCU CPU L)*/
    ...
    [LVTS_MCU_CONTROLLER2] = {/*(MCU CPU B)*/
    ...
    [LVTS_AP_CONTROLLER1] = {/*(AP APU)*/
        .ts = {L_TS_LVTS6_0, L_TS_LVTS6_2},
        .ts_number = 2,
        .dominator_ts_idx = 0, //TODO: need confirm dominator sensor
        .tc_offset = 0x100,
        .tc_speed = {
...
static void lvts_thermal_cal_prepare(void)
{
    ...
    for (i = 0; (i + 5) < countof(temp); i = i + 5)
    ...
    g_cali_mode = (temp[0] & _BITMASK_(31:31));//0x11F1_01C4
    g_golden_temp = (temp[0] & _BITMASK_(7:0));//0x11F1_01C4
    g_golden_temp_ht = ((temp[0] & _BITMASK_(15:8)) >> 8);//0x11F1_01C4
    g_count_r[L_TS_LVTS1_0] = (temp[1] & _BITMASK_(15:0)); //0x11F1_01C8,LVTS1_0
    g_count_r[L_TS_LVTS1_1] = ((temp[1] & _BITMASK_(31:16)) >> 16); //0x11F1_01C8,LVTS1_1
    g_count_r[L_TS_LVTS1_2] = (temp[2] & _BITMASK_(15:0)); //0x11F1_01CC,LVTS1_2
    g_count_r[L_TS_LVTS1_3] = ((temp[2] & _BITMASK_(31:16)) >> 16); //0x11F1_01CC,LVTS1_3
    g_count_r[L_TS_LVTS2_0] = (temp[3] & _BITMASK_(15:0)); //0x11F1_01D0,LVTS2_0
    g_count_r[L_TS_LVTS2_1] = ((temp[3] & _BITMASK_(31:16)) >> 16); //0x11F1_01D0,LVTS2_1
    g_count_r[L_TS_LVTS2_2] = (temp[4] & _BITMASK_(15:0)); //0x11F1_01D4,LVTS2_2
    g_count_r[L_TS_LVTS2_3] = ((temp[4] & _BITMASK_(31:16)) >> 16); //0x11F1_01D4,LVTS2_3
    g_count_r[L_TS_LVTS3_0] = (temp[5] & _BITMASK_(15:0)); //0x11F1_01D8,LVTS3_0
    g_count_r[L_TS_LVTS3_1] = ((temp[5] & _BITMASK_(31:16)) >> 16); //0x11F1_01D8,LVTS3_1
    g_count_r[L_TS_LVTS3_2] = (temp[6] & _BITMASK_(15:0)); //0x11F1_01DC,LVTS3_2
    g_count_r[L_TS_LVTS3_3] = ((temp[6] & _BITMASK_(31:16)) >> 16); //0x11F1_01DC,LVTS3_3
    g_count_r[L_TS_LVTS5_0] = (temp[9] & _BITMASK_(15:0)); //0x11F1_01E8,LVTS5_0
    g_count_r[L_TS_LVTS5_1] = ((temp[9] & _BITMASK_(31:16)) >> 16); //0x11F1_01E8,LVTS5_1
    g_count_r[L_TS_LVTS6_0] = (temp[10] & _BITMASK_(15:0)); //0x11F1_01EC,LVTS6_0
    g_count_r[L_TS_LVTS6_2] = (temp[11] & _BITMASK_(15:0)); //0x11F1_01F0,LVTS6_2
    g_count_r[L_TS_LVTS7_0] = (temp[12] & _BITMASK_(15:0)); //0x11F1_01F4,LVTS7_0
    g_count_r[L_TS_LVTS7_1] = ((temp[12] & _BITMASK_(31:16)) >> 16); //0x11F1_01F4,LVTS7_1
    g_count_r[L_TS_LVTS7_2] = (temp[13] & _BITMASK_(15:0)); //0x11F1_01F8,LVTS7_2
    g_count_r[L_TS_LVTS8_0] = ((temp[13] & _BITMASK_(31:16)) >> 16); //0x11F1_01F8,LVTS8_0
    g_count_r[L_TS_LVTS8_1] = (temp[14] & _BITMASK_(15:0)); //0x11F1_01FC,LVTS8_1
    g_count_r[L_TS_LVTS8_2] = ((temp[14] & _BITMASK_(31:16)) >> 16); //0x11F1_01FC,LVTS8_2
    g_count_r[L_TS_LVTS9_0] = (temp[15] & _BITMASK_(15:0)); //0x11F1_0200,LVTS9_0
    g_count_r[L_TS_LVTS9_1] = ((temp[15] & _BITMASK_(31:16)) >> 16); //0x11F1_0200,LVTS9_1
    g_count_r[L_TS_LVTS9_2] = (temp[16] & _BITMASK_(15:0)); //0x11F1_0204,LVTS9_2
    /*020C, LVTS1_0_COUNT_RC*/
    g_count_rc[LVTS_MCU_CONTROLLER0] = (temp[18] & _BITMASK_(23:0)); //0x11F1_020C,LVTS1
    g_count_rc[LVTS_MCU_CONTROLLER1] = (temp[19] & _BITMASK_(23:0)); //0x11F1_0210,LVTS2
    g_count_rc[LVTS_MCU_CONTROLLER2] = (temp[20] & _BITMASK_(23:0)); //0x11F1_0214,LVTS3
    g_count_rc[LVTS_AP_CONTROLLER0] = (temp[22] & _BITMASK_(23:0)); //0x11F1_021C,LVTS5
    g_count_rc[LVTS_AP_CONTROLLER1] = (temp[23] & _BITMASK_(23:0)); //0x11F1_0970,LVTS6
    g_count_rc[LVTS_AP_CONTROLLER2] = (temp[24] & _BITMASK_(23:0)); //0x11F1_0974,LVTS7
    g_count_rc[LVTS_AP_CONTROLLER3] = (temp[25] & _BITMASK_(23:0)); //0x11F1_0978,LVTS8
    g_count_rc[LVTS_AP_CONTROLLER4] = (temp[26] & _BITMASK_(23:0)); //0x11F1_097C,LVTS9
...
static void lvts_tscpu_thermal_initial_all_tc(void)
{
    ...
    for (i = 0; i < countof(lvts_tscpu_g_tc); i++) {
        ...
        if (i == LVTS_AP_CONTROLLER1)
            mt_reg_sync_writel_print(0x13111210, (void *)(LVTSTSSEL_0 + offset));
        else
...
static void lvts_device_read_count_RC_N(void)
{
    ...
    for (i = 0; i < countof(lvts_tscpu_g_tc); i++) {
        ...
        for (j = 0; j < num_ts; j++) {
            ...
            if (s_index == L_TS_LVTS6_2)
                lvts_write_device(0xC1030000, 0x0D, 2, i);
            else
            ...
            lvts_write_device(0xC1030000, 0x08, 0xB5, i);
            /* Toggle VCO_RST */
            lvts_write_device(0xC1030000, 0x08, 0xBD, i);
            /* Set TS_EN and DEV_EN */
            lvts_write_device(0xC1030000, 0x08, 0xB5, i);
            /* wait 8us */
            spin(10);
