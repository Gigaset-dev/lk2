...
static struct pmif mt6895_pmif_m_arb = {
...
static struct spmi_device mt6895_spmi_dev[] = {
    {
        .slvid = SPMI_SLAVE_4,
...
{
    spmi_device_register(mt6895_spmi_dev, countof(mt6895_spmi_dev));
}
