...
#define CCCI_NO_NEED_CHANGE_MDSS

/* size setting */
 /* SIB */
#define CCCI_SMEM_SIB_MAX_SIZE  (0x60000000)
#define CCCI_SMEM_SIB_AT_BANK4
...
#define CCCI_SMEM_WIFI_MD_PROXY (64*1024)
...
#define CCB_GEAR_SUPPORT_LIST "1(2,20);2(2,10);3(0,0);4(2,30);6(2,50);11(2,2);12(2,62)"
...
#else
#define RO_RW_MEM_LIMIT        0x100000000LL
#endif
