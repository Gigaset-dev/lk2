...
#define SSPM_MPU_REGION_ROM      4
#define SSPM_MPU_REGION_SHARE    5

/*SSPM_MEM_SIZE Should be large than SSPM_IMG_SZ + SSPM_TCM_SZ + SSPM_CPM_SZ */
#define SSPM_MEM_SIZE       0x00180000  // 1.5M
#define SSPM_DRAM_ADDR_MAX  0x9FFFFFFF  // max address can remap
...
#define LEGACY_EMIMPU       1           // Using legacy mpu
