...
struct lvts_thermal_controller lvts_tscpu_g_tc[LVTS_CONTROLLER_NUM] = {
    ...
    [LVTS_AP_CONTROLLER3] = {/*(MD)*/
            .ts = {L_TS_LVTS4_0},
            .ts_number = 1,
            .dominator_ts_idx = 0, //TODO: need confirm dominator sensor
            .tc_offset = 0x300, //0x1100B300 = 0x1100B000 + 300
            .tc_speed = {
                .group_interval_delay = 0x001,
                .period_unit = 0x00c,
                .filter_interval_delay = 0x001,
...
static void lvts_thermal_cal_prepare(void)
{
    ...
    g_count_r[L_TS_LVTS1_0] =  (temp[1] & _BITMASK_(15:0));
    g_count_r[L_TS_LVTS1_1] =  ((temp[1] & _BITMASK_(31:16))>>16);
    g_count_r[L_TS_LVTS1_2] =  (temp[2] & _BITMASK_(15:0));
    g_count_r[L_TS_LVTS1_3] =  ((temp[2] & _BITMASK_(31:16))>>16);
    g_count_r[L_TS_LVTS2_0] =  (temp[3] & _BITMASK_(15:0));
    g_count_r[L_TS_LVTS2_1] =  ((temp[3] & _BITMASK_(31:16))>>16);
    g_count_r[L_TS_LVTS2_2] =  (temp[4] & _BITMASK_(15:0));
    g_count_r[L_TS_LVTS2_3] =  ((temp[4] & _BITMASK_(31:16))>>16);
    g_count_r[L_TS_LVTS3_0] =  (temp[5] & _BITMASK_(15:0));
    g_count_r[L_TS_LVTS3_1] =  ((temp[5] & _BITMASK_(31:16))>>16);
    g_count_r[L_TS_LVTS3_2] =  (temp[6] & _BITMASK_(15:0));
    g_count_r[L_TS_LVTS3_3] =  ((temp[6] & _BITMASK_(31:16))>>16);
    g_count_r[L_TS_LVTS4_0] =  (temp[7] & _BITMASK_(15:0));


    g_count_rc[LVTS_AP_CONTROLLER0] = (temp[8] & _BITMASK_(23:0));

    g_count_rc[LVTS_AP_CONTROLLER1] = (temp[9] & _BITMASK_(23:0));

    g_count_rc[LVTS_AP_CONTROLLER2] = (temp[10] & _BITMASK_(23:0));

    g_count_rc[LVTS_AP_CONTROLLER3] = (temp[11] & _BITMASK_(23:0));
