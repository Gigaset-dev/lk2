...
#define MSDC1_IO_PAD_BASE       (IOCFG_RB_BASE)
...
#define MSDC0_GPIO_RDSEL0   (MSDC0_IO_PAD_BASE + 0xB0)
#define MSDC0_GPIO_RDSEL1   (MSDC0_IO_PAD_BASE + 0xC0)
#define MSDC0_GPIO_RDSEL2   (MSDC0_IO_PAD_BASE + 0xD0)
#define MSDC0_GPIO_SMT      (MSDC0_IO_PAD_BASE + 0xF0)
#define MSDC0_GPIO_TDSEL0   (MSDC0_IO_PAD_BASE + 0x100)
#define MSDC0_GPIO_TDSEL1   (MSDC0_IO_PAD_BASE + 0x110)
...
#define MSDC0_TDSEL0_ALL_MASK   (0xFFFFFF << 8)
/* MSDC0 TDSEL1 mask */
...
#define MSDC0_TDSEL1_DSL_MASK   (0xF << 16)
#define MSDC0_TDSEL1_RSTB_MASK  (0xF << 20)
#define MSDC0_TDSEL1_ALL_MASK   (0xFFFFF << 0)
/* MSDC0 RDSEL0 mask */
...
#define MSDC0_RDSEL0_ALL_MASK   (0xFFFFFF << 4)
/* MSDC0 RDSEL1 mask */
#define MSDC0_RDSEL1_DAT2_MASK    (0x3F << 0)
#define MSDC0_RDSEL1_DAT3_MASK    (0x3F << 6)
#define MSDC0_RDSEL1_DAT4_MASK    (0x3F << 12)
#define MSDC0_RDSEL1_DAT5_MASK    (0x3F << 18)
#define MSDC0_RDSEL1_DAT6_MASK    (0x3F << 24)
#define MSDC0_RDSEL1_ALL_MASK     (0x3FFFFFFF << 0)
/* MSDC0 RDSEL2 mask */
#define MSDC0_RDSEL2_DAT7_MASK   (0x3F << 0)
#define MSDC0_RDSEL2_DSL_MASK    (0x3F << 6)
#define MSDC0_RDSEL2_RSTB_MASK   (0x3F << 12)
...
#define MSDC0_DRV0_ALL_MASK     (0xFFFFFF << 6)
/* MSDC0 DRV1 mask */
#define MSDC0_DRV1_DAT6_MASK    (0x7 << 0)
#define MSDC0_DRV1_DAT7_MASK    (0x7 << 3)
#define MSDC0_DRV1_DSL_MASK     (0x7 << 6)
#define MSDC0_DRV1_RSTB_MASK    (0x7 << 9)
#define MSDC0_DRV1_ALL_MASK     (0x1FF << 0)
/* MSDC0 PUPD mask*/
