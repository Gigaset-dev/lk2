...
enum {
    ...
    DEIMOS_CPU4_BASE     = MCUCFG_BASE + 0x00002000,
    DEIMOS_CPU5_BASE     = MCUCFG_BASE + 0x00002800,
    DEIMOS_CPU6_BASE     = MCUCFG_BASE + 0x00003000,
    DEIMOS_CPU7_BASE     = MCUCFG_BASE + 0x00003800,
    MP_CPUSYS_TOP_BASE   = MCUCFG_BASE + 0x00008000,
    CPCCFG_REG_BASE      = MCUCFG_BASE + 0x0000A800,
    MCUSYS_CFG_REG_BASE  = MCUCFG_BASE + 0x0000C000,
};
...
enum {
    ...
    I2C10_BASE           = IO_BASE + 0x01015000,
    I2C11_BASE           = IO_BASE + 0x01017000,
    ...
    I2C8_BASE            = IO_BASE + 0x01D00000,
    I2C9_BASE            = IO_BASE + 0x01D01000,
