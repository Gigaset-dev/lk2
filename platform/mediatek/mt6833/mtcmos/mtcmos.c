...
struct mtk_infracfg_ao_regs {
    ...
    uint32_t infra_topaxi_protecten_vdnr;
    ...
    uint32_t reserved11[141];
    uint32_t infra_topaxi_protecten_mm_2;
    uint32_t infra_topaxi_protecten_mm_2_set;
    uint32_t infra_topaxi_protecten_mm_2_clr;
    uint32_t reserved12[1];
    uint32_t infra_topaxi_protecten_mm_sta1_2;
};
...
STATIC_ASSERT(__offsetof(struct mtk_infracfg_ao_regs, infra_topaxi_protecten_sta1_2)
        == 0x0724);
STATIC_ASSERT(__offsetof(struct mtk_infracfg_ao_regs, infra_topaxi_protecten_vdnr)
        == 0x0B80);
STATIC_ASSERT(__offsetof(struct mtk_infracfg_ao_regs, infra_topaxi_protecten_vdnr_set)
        == 0x0B84);
STATIC_ASSERT(__offsetof(struct mtk_infracfg_ao_regs, infra_topaxi_protecten_vdnr_clr)
        == 0x0B88);
STATIC_ASSERT(__offsetof(struct mtk_infracfg_ao_regs, infra_topaxi_protecten_vdnr_sta1)
        == 0x0B90);
STATIC_ASSERT(__offsetof(struct mtk_infracfg_ao_regs, infra_topaxi_protecten_mm_2)
        == 0x0DC8);
STATIC_ASSERT(__offsetof(struct mtk_infracfg_ao_regs, infra_topaxi_protecten_mm_2_set)
        == 0x0DCC);
STATIC_ASSERT(__offsetof(struct mtk_infracfg_ao_regs, infra_topaxi_protecten_mm_2_clr)
        == 0x0DD0);
STATIC_ASSERT(__offsetof(struct mtk_infracfg_ao_regs, infra_topaxi_protecten_mm_sta1_2)
        == 0x0DD8);
...
enum {
    DIS_PWR_STA_MASK = 1 << 21,
    MD1_PWR_STA_MASK = 1 << 0,
    MFG0_PWR_STA_MASK = 1 << 2,
    MFG1_PWR_STA_MASK = 1 << 3,
    MFG2_PWR_STA_MASK = 1 << 4,
    MFG3_PWR_STA_MASK = 1 << 5,
};

enum {
    DIS_SRAM_PDN = 1 << 8,
    DIS_SRAM_PDN_ACK = 1 << 12,
    MD1_SRAM_PDN = 1 << 8,
    MD1_SRAM_PDN_ACK = 1 << 12,
    MFG0_SRAM_PDN = 1 << 8,
    MFG0_SRAM_PDN_ACK = 1 << 12,
    MFG1_SRAM_PDN = 1 << 8,
    MFG1_SRAM_PDN_ACK = 1 << 12,
    MFG2_SRAM_PDN = 1 << 8,
    MFG2_SRAM_PDN_ACK = 1 << 12,
    MFG3_SRAM_PDN = 1 << 8,
    MFG3_SRAM_PDN_ACK = 1 << 12,
};

enum {
    DIS_PROT_STEP0_0_MASK = ((1 << 0) | (1 << 2) | (1 << 10) | (1 << 12)
        | (1 << 16) | (1 << 24) | (1 << 26)),
    DIS_PROT_STEP0_0_ACK_MASK = ((1 << 0) | (1 << 2) | (1 << 10) | (1 << 12)
        | (1 << 16) | (1 << 24) | (1 << 26)),
    DIS_PROT_STEP1_0_MASK = 1 << 8,
    DIS_PROT_STEP1_0_ACK_MASK = 1 << 8,
    DIS_PROT_STEP2_0_MASK = ((1 << 6) | (1 << 23)),
    DIS_PROT_STEP2_0_ACK_MASK = ((1 << 6) | (1 << 23)),
    DIS_PROT_STEP3_0_MASK = ((1 << 1) | (1 << 3) | (1 << 17) | (1 << 25) | (1 << 27)),
    DIS_PROT_STEP3_0_ACK_MASK = ((1 << 1) | (1 << 3) | (1 << 17) | (1 << 25) | (1 << 27)),
    DIS_PROT_STEP4_0_MASK = 1 << 9,
    DIS_PROT_STEP4_0_ACK_MASK = 1 << 9,
    MD1_PROT_STEP0_0_MASK = 1 << 7,
    MD1_PROT_STEP0_0_ACK_MASK = 1 << 7,
    MD1_PROT_STEP1_0_MASK = ((1 << 0) | (1 << 10) | (1 << 16)),
    MD1_PROT_STEP1_0_ACK_MASK = ((1 << 0) | (1 << 10) | (1 << 16)),
    MFG1_PROT_STEP0_0_MASK = 1 << 21,
    MFG1_PROT_STEP0_0_ACK_MASK = 1 << 21,
...
static void ram_console_update(void)
{
    ...
    if (loop_cnt > 100000 && !log_dump) {
        ...
        dprintf(CRITICAL, "infra_topaxi_protecten_vdnr=%08x\n",
                read32(&mtk_infracfg_ao->infra_topaxi_protecten_vdnr));
        dprintf(CRITICAL, "infra_topaxi_protecten_vdnr_sta1=%08x\n",
                read32(&mtk_infracfg_ao->infra_topaxi_protecten_vdnr_sta1));
        dprintf(CRITICAL, "infra_topaxi_protecten_mm_2=%08x\n",
                read32(&mtk_infracfg_ao->infra_topaxi_protecten_mm_2));
        dprintf(CRITICAL, "infra_topaxi_protecten_mm_sta1_2=%08x\n",
                read32(&mtk_infracfg_ao->infra_topaxi_protecten_mm_sta1_2));
...
void spm_mtcmos_ctrl_md1_enable(void)
{
    ...
    INCREASE_STEPS;
    #endif
    write32(&mtk_infracfg_ao->infra_topaxi_protecten_vdnr_clr, MD1_PROT_STEP1_0_MASK);
...
void spm_mtcmos_ctrl_md1_disable(void)
{
    ...
    INCREASE_STEPS;
    #endif
    write32(&mtk_infracfg_ao->infra_topaxi_protecten_vdnr_set, MD1_PROT_STEP1_0_MASK);
    #ifndef IGNORE_MTCMOS_CHECK
    while ((read32(&mtk_infracfg_ao->infra_topaxi_protecten_vdnr_sta1)
...
void spm_mtcmos_ctrl_dis_enable(void)
{
    ...
    INCREASE_STEPS;
    #endif
    write32(&mtk_infracfg_ao->infra_topaxi_protecten_mm_2_clr, DIS_PROT_STEP4_0_MASK);
    write32(&mtk_infracfg_ao->infra_topaxi_protecten_mm_clr, DIS_PROT_STEP3_0_MASK);
    write32(&mtk_infracfg_ao->infra_topaxi_protecten_clr, DIS_PROT_STEP2_0_MASK);
    write32(&mtk_infracfg_ao->infra_topaxi_protecten_mm_2_clr, DIS_PROT_STEP1_0_MASK);
...
void spm_mtcmos_ctrl_dis_disable(void)
{
    ...
    INCREASE_STEPS;
    #endif
    write32(&mtk_infracfg_ao->infra_topaxi_protecten_mm_2_set, DIS_PROT_STEP1_0_MASK);
    #ifndef IGNORE_MTCMOS_CHECK
    while ((read32(&mtk_infracfg_ao->infra_topaxi_protecten_mm_sta1_2)
    ...
    INCREASE_STEPS;
    #endif
    write32(&mtk_infracfg_ao->infra_topaxi_protecten_set, DIS_PROT_STEP2_0_MASK);
    #ifndef IGNORE_MTCMOS_CHECK
    while ((read32(&mtk_infracfg_ao->infra_topaxi_protecten_sta1)
    ...
    INCREASE_STEPS;
    #endif
    write32(&mtk_infracfg_ao->infra_topaxi_protecten_mm_set, DIS_PROT_STEP3_0_MASK);
    #ifndef IGNORE_MTCMOS_CHECK
    while ((read32(&mtk_infracfg_ao->infra_topaxi_protecten_mm_sta1)
    ...
    INCREASE_STEPS;
    #endif
    write32(&mtk_infracfg_ao->infra_topaxi_protecten_mm_2_set, DIS_PROT_STEP4_0_MASK);
    #ifndef IGNORE_MTCMOS_CHECK
    while ((read32(&mtk_infracfg_ao->infra_topaxi_protecten_mm_sta1_2)
