...
#define DISP_REG_DSI_COM_CON                               (0x010UL)
    #define DSI_COM_CON_FLD_DSI_WAIT_DATA_EN               REG_FLD_MSB_LSB(24, 24)
...
#define DISP_REG_DSI_DEBUG_SEL                             (0x170UL)
    #define DSI_DEBUG_SEL_FLD_DSI_MM_RST_SEL               REG_FLD_MSB_LSB(10, 10)
...
#define DISP_REG_DSI_BUF_CON0                (0x400UL)
    #define DSI_BUF_CON0_FLD_EN              REG_FLD_MSB_LSB(0, 0)
#define DISP_REG_DSI_BUF_CON1                (0x404UL)
    #define BUF_BUF_OUTPUT_VALID_THESHOLD    REG_FLD_MSB_LSB(14, 0)
#define DISP_REG_DSI_BUF_RW_TIMES            (0x410UL)
#define DISP_REG_DSI_BUF_SODI_HIGH           (0x414UL)
#define DISP_REG_DSI_BUF_SODI_LOW            (0x418UL)
#define DISP_REG_DSI_BUF_PREULTRA_HIGH       (0x424UL)
#define DISP_REG_DSI_BUF_PREULTRA_LOW        (0x428UL)
#define DISP_REG_DSI_BUF_ULTRA_HIGH          (0x42CUL)
#define DISP_REG_DSI_BUF_ULTRA_LOW           (0x430UL)
#define DISP_REG_DSI_BUF_URGENT_HIGH         (0x434UL)
#define DISP_REG_DSI_BUF_URGENT_LOW          (0x438UL)
    #define DSI_BUF_FLD_GS                    REG_FLD_MSB_LSB(19, 0)
