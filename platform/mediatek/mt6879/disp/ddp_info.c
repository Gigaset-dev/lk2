...
struct ddp_module ddp_modules[DISP_MODULE_NUM] = {
        ...
        {DISP_MODULE_C3D0, "c3d0", 1, &ddp_driver_c3d},
        ...
        {DISP_MODULE_CHIST0, "chist0", 1, NULL},
        {DISP_MODULE_CHIST1, "chist1", 1, NULL},
        ...
        {DISP_MODULE_MERGE0, "merge0", 1, NULL},
        {DISP_MODULE_DSI0, "dsi0", 1, &ddp_driver_dsi0},
        {DISP_MODULE_WDMA0, "wdma0", 1, NULL},
        {DISP_MODULE_UFBC_WDMA0, "wdma0", 1, NULL},
        {DISP_MODULE_OVL0_2L_NWCG, "ovl0_2l_nwcg", 1, NULL},
        {DISP_MODULE_OVL1_2L_NWCG, "ovl1_2l_nwcg", 1, NULL},
        {DISP_MODULE_RDMA1, "rdma1", 1, &ddp_driver_rdma},
        {DISP_MODULE_DP_INTF0, "dp_intf0", 1, NULL},
        {DISP_MODULE_DPI0, "dpi", 1, NULL},
        {DISP_MODULE_WDMA1, "wdma1", 1, NULL},
        {DISP_MODULE_Y2R0, "y2r0", 1, NULL},
        {DISP_MODULE_INLINEROT0, "inlinerot0", 1, NULL},
        {DISP_MODULE_DLI_ASYNC0, "dli_async0", 1, NULL},
        {DISP_MODULE_DLI_ASYNC1, "dli_async1", 1, NULL},
        {DISP_MODULE_DLI_ASYNC2, "dli_async2", 1, NULL},
        {DISP_MODULE_DLI_ASYNC3, "dli_async3", 1, NULL},
        {DISP_MODULE_DLO_ASYNC0, "dlo_async0", 1, NULL},
        {DISP_MODULE_DLO_ASYNC1, "dlo_async1", 1, NULL},
        {DISP_MODULE_DLO_ASYNC2, "dlo_async2", 1, NULL},
        {DISP_MODULE_DLO_ASYNC3, "dlo_async3", 1, NULL},
        ...
        {DISP_MODULE_MAIN_OVL_WDMA0_VIRTUAL, "main_ovl_wdma0_virt", 1, NULL},
...
struct DISP_MUTEX_REGS *g_DISP_MUTEX_BASE = (struct DISP_MUTEX_REGS *)DISP_MUTEX_BASE;
struct DISP_OVL0_REGS *g_DISP_OVL0_BASE = (struct DISP_OVL0_REGS *)DISP_OVL0_BASE;
...
int ddp_enable_module_clock(enum DISP_MODULE_ENUM module)
{
    ...
    case DISP_MODULE_OVL0_2L:
        DISP_REG_SET_FIELD(NULL, FLD_CG1_DISP_OVL0_2L, DISP_REG_CONFIG_MMSYS_CG_CLR1, 1);
        break;
...
int ddp_disable_module_clock(enum DISP_MODULE_ENUM module)
{
    ...
    case DISP_MODULE_OVL0:
        ...
        break;
    case DISP_MODULE_OVL0_2L:
        DISP_REG_SET_FIELD(NULL, FLD_CG1_DISP_OVL0_2L, DISP_REG_CONFIG_MMSYS_CG_SET1, 1);
        break;
    case DISP_MODULE_RDMA0:
...
void ddp_init_modules_driver(void)
{
    ...
    DISP_REG_SET(NULL, DISP_REG_CONFIG_EMI_REQ_CTL, 0xdf);
}
