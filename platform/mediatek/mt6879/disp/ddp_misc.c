...
{
    DDPMSG("bypass c3d\n");
    DISP_REG_SET(NULL, DISP_REG_C3D0_C3D_SIZE, width << 16 | height);
    DISP_REG_SET(NULL, DISP_REG_C3D0_C3D_CFG, 0X11);
    DISP_REG_SET(NULL, DISP_REG_C3D0_C3D_EN, 0x1);
}
    ...
    unsigned int width, unsigned int height, void *handle)
{
    ...
    DISP_REG_SET(NULL, DISP_REG_CCORR_SIZE + offset, (width << 16) | height);
