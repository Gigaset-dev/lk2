...
#define DISP_REG_CONFIG_MMSYS_MISC               (DISPSYS_CONFIG_BASE + 0x0F0)
    ...
    #define FLD_OVL0_2L_NWCG_ULTRA_SEL           REG_FLD_MSB_LSB(17, 14)

#define DISP_REG_CONFIG_EMI_REQ_CTL              (DISPSYS_CONFIG_BASE + 0x0F8)
...
#define DISP_REG_CONFIG_MMSYS_CG_CLR0            (DISPSYS_CONFIG_BASE + 0x108)
    ...
    #define FLD_CG0_SPR0                         REG_FLD(1, 26)
    #define FLD_CG0_CM0                          REG_FLD(1, 25)
    ...
    #define FLD_CG0_CCORR1                       REG_FLD(1, 20)
    ...
    #define FLD_CG0_DISP_DPI0                    REG_FLD(1, 7)
    #define FLD_CG0_DISP_FAKE_ENG1               REG_FLD(1, 6)
    #define FLD_CG0_DISP_WDMA0                   REG_FLD(1, 5)
    #define FLD_CG0_INLINEROT0                   REG_FLD(1, 4)
    #define FLD_CG0_FAKE_ENG0                    REG_FLD(1, 3)
    #define FLD_CG0_MERGE0                       REG_FLD(1, 2)
...
#define DISP_REG_CONFIG_MMSYS_CG_CLR1            (DISPSYS_CONFIG_BASE + 0x118)
    ...
    #define FLD_CG1_DISPSYS_CONFIG               REG_FLD(1, 1)
