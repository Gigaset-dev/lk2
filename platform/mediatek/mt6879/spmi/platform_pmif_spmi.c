...
static struct pmif mt6879_pmif_m_arb = {
...
static struct spmi_device mt6879_spmi_dev[] = {
    {
        .slvid = SPMI_SLAVE_4,
...
{
    spmi_device_register(mt6879_spmi_dev, countof(mt6879_spmi_dev));
}
