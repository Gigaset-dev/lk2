...
static void lvts_thermal_cal_prepare(void)
{
    ...
    temp[22] = get_devinfo_with_index(LVTS_ADDRESS_INDEX_23);

    temp[23] = get_devinfo_with_index(LVTS_ADDRESS_INDEX_24);
    ...
    THERM_LOG("[lvts_call] (20: 0x%x)(21: 0x%x)(22: 0x%x)(23: 0x%x)\n",
        temp[20], temp[21], temp[22], temp[23]);


    g_golden_temp = ((temp[0] & _BITMASK_(31:24)) >> 24);

    g_count_r[L_TS_LVTS1_0] =  (temp[1] & _BITMASK_(23:0));
    g_count_r[L_TS_LVTS1_1] =  (temp[2] & _BITMASK_(23:0));
    g_count_r[L_TS_LVTS2_0] =  (temp[3] & _BITMASK_(23:0));
    g_count_r[L_TS_LVTS2_1] =  (temp[4] & _BITMASK_(23:0));
    g_count_r[L_TS_LVTS2_2] =  (temp[5] & _BITMASK_(23:0));
    g_count_r[L_TS_LVTS2_3] =  (temp[6] & _BITMASK_(23:0));
    g_count_r[L_TS_LVTS3_0] =  (temp[7] & _BITMASK_(23:0));
    g_count_r[L_TS_LVTS3_1] =  (temp[8] & _BITMASK_(23:0));
    g_count_r[L_TS_LVTS4_0] =  (temp[9] & _BITMASK_(23:0));
    g_count_r[L_TS_LVTS4_1] =  (temp[10] & _BITMASK_(23:0));
    g_count_r[L_TS_LVTS5_0] = (temp[11] & _BITMASK_(23:0));
    g_count_r[L_TS_LVTS5_1] = (temp[12] & _BITMASK_(23:0));
    g_count_r[L_TS_LVTS5_2] = (temp[13] & _BITMASK_(23:0));
    g_count_r[L_TS_LVTS5_3] = (temp[14] & _BITMASK_(23:0));
    g_count_r[L_TS_LVTS6_0] = (temp[15] & _BITMASK_(23:0));
    g_count_r[L_TS_LVTS6_1] = (temp[16] & _BITMASK_(23:0));
    g_count_r[L_TS_LVTS6_2] = (temp[17] & _BITMASK_(23:0));
    g_count_r[L_TS_LVTS6_3] = (temp[18] & _BITMASK_(23:0));


    g_count_rc[LVTS_MCU_CONTROLLER0] = (temp[23] & _BITMASK_(23:0));

    g_count_rc[LVTS_MCU_CONTROLLER1] = ((temp[1] & _BITMASK_(31:24)) >> 8) +
                    ((temp[2] & _BITMASK_(31:24)) >> 16) +
                    ((temp[3] & _BITMASK_(31:24)) >> 24);

    g_count_rc[LVTS_AP_CONTROLLER0] = ((temp[4] & _BITMASK_(31:24)) >> 8) +
                    ((temp[5] & _BITMASK_(31:24)) >> 16) +
                    ((temp[6] & _BITMASK_(31:24)) >> 24);

    g_count_rc[LVTS_AP_CONTROLLER1] = ((temp[7] & _BITMASK_(31:24)) >> 8) +
                    ((temp[8] & _BITMASK_(31:24)) >> 16) +
                    ((temp[9] & _BITMASK_(31:24)) >> 24);

    g_count_rc[LVTS_AP_CONTROLLER2] = ((temp[10] & _BITMASK_(31:24)) >> 8) +
                    ((temp[11] & _BITMASK_(31:24)) >> 16) +
                    ((temp[12] & _BITMASK_(31:24)) >> 24);

    g_count_rc[LVTS_AP_CONTROLLER3] = ((temp[13] & _BITMASK_(31:24)) >> 8) +
