...
#define CLKCFG_ADSP_SEL                 (IO_BASE + 0x00C0)
#define CLKCFG_ADSP_SEL_SET             (IO_BASE + 0x00C4)
#define CLKCFG_ADSP_SEL_CLR             (IO_BASE + 0x00C8)
#define ADSP_CK_UPDATE                  (16)
#define ADSP_SEL_OFFSET                 (24)
#define ADSPPLL_CK                      (7)
#define CLK_26M_CK                      (0)
...
#define ADSP_ALTVECSEL                  (ADSP_BASE + 0xB00C)
