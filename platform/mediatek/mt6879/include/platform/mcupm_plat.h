...
#define MCUPM_SRAM_BASE       (GIC_BASE + 0x00540000) // GIC_BASE define in addressmap.h
#define MCUPM_SW_RSTN         (GIC_BASE + 0x00560000)
...
#define MCUPM_LOADER_SIZE       0x2300
#define MCUPM_TCM_SZ            0x00020000  // 128K
#define MCUPM_IMG_OFS           0x2300
