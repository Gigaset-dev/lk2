...
#if defined(MTK_MSDC_BRINGUP_DEBUG)
    if (id == 0) {
        dprintf(ALWAYS, "MSDC0 MODE5[%lx] = 0x%X\tshould: 0x11111???\n",
                MSDC0_GPIO_MODE5, MSDC_READ32(MSDC0_GPIO_MODE5));
        dprintf(ALWAYS, "MSDC0 MODE6[%lx] = 0x%X\tshould: 0x?1111111\n",
                MSDC0_GPIO_MODE6, MSDC_READ32(MSDC0_GPIO_MODE6));
        dprintf(ALWAYS, "MSDC0 IES   [%lx] = 0x%X\tshould: 0x????1FFE\n",
        ...
        dprintf(ALWAYS, "MSDC0 TDSEL0_0[%lx] = 0x%X,[%lx] = 0x%X",
        ...
        dprintf(ALWAYS, "MSDC0 DRV0  [%lx] = 0x%X,  [%lx] = 0x%X",
