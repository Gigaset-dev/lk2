...
# The size of share dram (total = SCP_RESERVED_SHARE_DRAM_SIZE + SCP_DUMP_SIZE)
# Notice: The size of reserved-memory needs to be 4K-aligned
SCP_RESERVED_SHARE_DRAM_SIZE := 0x320000
SCP_DUMP_SIZE := 0x280000 #L2TCM:1MB, DRAM:1MB, L1C:256KB, REG:15KB, TBUF:1KB
