...
#define MSDC0_GPIO_MODE0        (MSDC_GPIO_BASE + 0x3E0)
#define MSDC0_GPIO_MODE1        (MSDC_GPIO_BASE + 0x3F0)
#define MSDC0_GPIO_DRV0_ADDR    (MSDC0_IO_PAD_BASE + 0x00)
#define MSDC0_GPIO_DRV1_ADDR    (MSDC0_IO_PAD_BASE + 0x10)
#define MSDC0_GPIO_IES_ADDR     (MSDC0_IO_PAD_BASE + 0x30)
#define MSDC0_GPIO_PUPD0_ADDR   (MSDC0_IO_PAD_BASE + 0x50)
#define MSDC0_GPIO_R0_ADDR      (MSDC0_IO_PAD_BASE + 0x70)
#define MSDC0_GPIO_R1_ADDR      (MSDC0_IO_PAD_BASE + 0x80)
#define MSDC0_GPIO_RDSEL0_ADDR  (MSDC0_IO_PAD_BASE + 0x90)
#define MSDC0_GPIO_RDSEL1_ADDR  (MSDC0_IO_PAD_BASE + 0xA0)
#define MSDC0_GPIO_RDSEL2_ADDR  (MSDC0_IO_PAD_BASE + 0xB0)
#define MSDC0_GPIO_SMT_ADDR     (MSDC0_IO_PAD_BASE + 0xC0)
#define MSDC0_GPIO_TDSEL0_ADDR  (MSDC0_IO_PAD_BASE + 0xD0)
#define MSDC0_GPIO_TDSEL1_ADDR  (MSDC0_IO_PAD_BASE + 0xE0)

/* MSDC1 */
#define MSDC1_GPIO_MODE0        (MSDC_GPIO_BASE + 0x400)
#define MSDC1_GPIO_MODE1        (MSDC_GPIO_BASE + 0x410)
 ...
 */
/* MSDC0_GPIO_MODE0, 001b is msdc mode*/
#define MSDC0_MODE_DAT4_MASK    (0x7 << 28)
#define MSDC0_MODE_DAT5_MASK    (0x7 << 24)
#define MSDC0_MODE_DAT6_MASK    (0x7 << 20)
#define MSDC0_MODE_DAT7_MASK    (0x7 << 16)
/* MSDC0_GPIO_MODE1, 001b is msdc mode */
#define MSDC0_MODE_DSL_MASK     (0x7 << 28)
#define MSDC0_MODE_DAT0_MASK    (0x7 << 24)
...
#define MSDC0_MODE_CMD_MASK     (0x7 << 4)
#define MSDC0_MODE_RSTB_MASK    (0x7 << 0)
...
#define MSDC0_TDSEL0_ALL_MASK   (0xFFFFFFFF)
/* MSDC0 TDSEL1 mask */
#define MSDC0_TDSEL1_DAT6_MASK  (0xF << 0)
#define MSDC0_TDSEL1_DAT7_MASK  (0xF << 4)
#define MSDC0_TDSEL1_DSL_MASK   (0xF << 8)
#define MSDC0_TDSEL1_RSTB_MASK  (0xF << 12)
#define MSDC0_TDSEL1_ALL_MASK   (0xFFFF)
/* MSDC0 RDSEL0 mask */
...
#define MSDC0_RDSEL0_ALL_MASK   (0x3FFFFFFF)
/* MSDC0 RDSEL1 mask */
#define MSDC0_RDSEL1_DAT7_MASK  (0x3F << 24)
#define MSDC0_RDSEL1_DAT6_MASK  (0x3F << 18)
#define MSDC0_RDSEL1_DAT5_MASK  (0x3F << 12)
#define MSDC0_RDSEL1_DAT4_MASK  (0x3F << 6)
#define MSDC0_RDSEL1_DAT3_MASK  (0x3F << 0)
#define MSDC0_RDSEL1_ALL_MASK   (0x3FFFFFFF)
/* MSDC0 RDSEL2 mask */
#define MSDC0_RDSEL2_RSTB_MASK  (0x3F << 6)
#define MSDC0_RDSEL2_DSL_MASK   (0x3F << 0)
#define MSDC0_RDSEL2_ALL_MASK   (0xFFF)
/* MSDC0 DRV0 mask */
...
#define MSDC0_DRV0_ALL_MASK     (0x3FFFFFFF)
/* MSDC0 DRV1 mask */
#define MSDC0_DRV1_DSL_MASK     (0x7 << 0)
#define MSDC0_DRV1_RSTB_MASK    (0x7 << 3)
#define MSDC0_DRV1_ALL_MASK     (0x3F)
/* MSDC0 PUPD mask*/
