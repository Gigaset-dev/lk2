...
#define MSDC0_GPIO_MODE25   (MSDC_GPIO_BASE + 0x490)
...
#define MSDC0_GPIO_RDSEL1   (MSDC0_IO_PAD_BASE + 0x70)
#define MSDC0_GPIO_RDSEL2   (MSDC0_IO_PAD_BASE + 0x80)
#define MSDC0_GPIO_SMT      (MSDC0_IO_PAD_BASE + 0x90)
#define MSDC0_GPIO_TDSEL0   (MSDC0_IO_PAD_BASE + 0xa0)
#define MSDC0_GPIO_TDSEL1   (MSDC0_IO_PAD_BASE + 0xb0)
...
#define MSDC0_MODE_DSL_MASK     (0x7 << 8)
...
#define MSDC0_MODE_DAT1_MASK    (0x7 << 28)
/* MSDC0_GPIO_MODE25, 001b is msdc mode */
#define MSDC0_MODE_DAT2_MASK    (0x7 << 0)
#define MSDC0_MODE_DAT3_MASK    (0x7 << 4)
#define MSDC0_MODE_DAT4_MASK    (0x7 << 8)
#define MSDC0_MODE_DAT5_MASK    (0x7 << 12)
#define MSDC0_MODE_DAT6_MASK    (0x7 << 16)
#define MSDC0_MODE_DAT7_MASK    (0x7 << 20)
/* MSDC0 IES mask */
...
#define MSDC0_SMT_RTSB_MASK     (0x1 << 11)
...
#define MSDC0_TDSEL1_ALL_MASK     (0xFFFF << 0)
/* MSDC0 RDSEL0 mask */
...
#define MSDC0_RDSEL2_ALL_MASK    (0xFFF << 0)
/* MSDC0 DRV0 mask */
...
#define MSDC0_DRV0_ALL_MASK      (0x3FFFFFFF << 0)
/* MSDC0 DRV1 mask */
#define MSDC0_DRV1_DSL_MASK      (0x7 << 0)
#define MSDC0_DRV1_RTSB_MASK     (0x7 << 3)
#define MSDC0_DRV1_ALL_MASK      (0x3F << 0)
/* MSDC0 PUPD mask*/
