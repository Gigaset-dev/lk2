...
static unsigned int ovl_offset(enum DISP_MODULE_ENUM module)
{
    ...
    case DISP_MODULE_OVL0:
        ...
        break;
    case DISP_MODULE_OVL1_2L:
        off = (unsigned int)DISP_OVL1_2L_BASE - (unsigned int)DISP_OVL0_BASE;
        break;
    default:
...
void ovl_cal_golden_setting(unsigned int *gs)
{
    ...
    gs[GS_OVL_RDMA_FIFO_SIZE] = 576;

    /* OVL_RDMA_MEM_GMC_SETTING_2 */
    gs[GS_OVL_RDMA_ISSUE_REQ_TH] = 383;
    gs[GS_OVL_RDMA_ISSUE_REQ_TH_URG] = 191;
    ...
    gs[GS_OVL_RDMA_GREQ_URG_NUM] = 0x2000BBBB;
