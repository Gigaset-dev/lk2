...
/* from CODA */
static unsigned long const DSI_REG_BASE[1] = {DISPSYS_DSI0_BASE};
...
#define DSI_PSCON_FLD_CUSTOM_HEADER_EN                         REG_FLD_MSB_LSB(23, 23)
#define DSI_PSCON_FLD_IN_HS_EN                                 REG_FLD_MSB_LSB(22, 22)
#define DSI_PSCON_FLD_RG_XY_SWAP                               REG_FLD_MSB_LSB(21, 21)
#define DSI_PSCON_FLD_DSI_PS_SEL                               REG_FLD_MSB_LSB(19, 16)
...
#define DISP_REG_DSI_VFP_EARLY_STOP_L0      (0x040UL)
#define DISP_REG_DSI_VFP_EARLY_STOP_L2      (0x044UL)
#define DISP_REG_DSI_VFP_EARLY_STOP_L4      (0x048UL)
#define DISP_REG_DSI_VFP_EARLY_STOP_L6      (0x04CUL)
...
#define DSI_HFP_WC_FLD_DSI_HFP_WC                              REG_FLD_MSB_LSB(14, 0)
...
#define DISP_REG_DSI_CMD_TYPE1_LP_EXT        (0x070UL)
#define DSI_CMD_CPHY_6BYTE_EN                                  REG_FLD_MSB_LSB(18, 18)
...
#define DISP_REG_DSI_CMD_TYPE1_HS                          (0x06CUL)
...
#define DISP_REG_DSI_CPHY_CON0               (0x120UL)
#define DSI_CPHY_CON0_CPHY_EN                                  REG_FLD_MSB_LSB(0, 0)

#define DISP_REG_DSI_CPHY_CON1                             (0x124UL)
#define DISP_REG_DSI_CPHY_DBG0                             (0x128UL)
#define DISP_REG_DSI_CPHY_DBG1                             (0x12CUL)
#define DISP_REG_DSI_CKSM_OUT                              (0x144UL)

#define DISP_REG_DSI_SELF_PAT_CON0                         (0x178UL)
#define DISP_REG_DSI_SELF_PAT_CON1                         (0x17CUL)


#define DISP_REG_DSI_VM_CMD_CON              (0x200UL)
...
#define DISP_REG_DSI_VM_CMD_CON1             (0x204UL)


#define DISP_REG_DSI_VM_CMD_DATA0            (0x208UL)
#define DISP_REG_DSI_VM_CMD_DATA4            (0x20CUL)
#define DISP_REG_DSI_VM_CMD_DATA8            (0x210UL)
#define DISP_REG_DSI_VM_CMD_DATAC            (0x214UL)
#define DISP_REG_DSI_VM_CMD_DATA10           (0x218UL)
#define DISP_REG_DSI_VM_CMD_DATA14           (0x21CUL)
#define DISP_REG_DSI_VM_CMD_DATA18           (0x220UL)
#define DISP_REG_DSI_VM_CMD_DATA1C           (0x224UL)
#define DISP_REG_DSI_VM_CMD_DATA20           (0x228UL)
#define DISP_REG_DSI_VM_CMD_DATA24           (0x22CUL)
#define DISP_REG_DSI_VM_CMD_DATA28           (0x230UL)
#define DISP_REG_DSI_VM_CMD_DATA2C           (0x234UL)
#define DISP_REG_DSI_VM_CMD_DATA30           (0x238UL)
#define DISP_REG_DSI_VM_CMD_DATA34           (0x23CUL)
#define DISP_REG_DSI_VM_CMD_DATA38           (0x240UL)
#define DISP_REG_DSI_VM_CMD_DATA3C           (0x244UL)
...
#define DISP_REG_DSI_CG_CONFIG               (0x198UL)
...
#define DISP_REG_DSI_CMDQ                    (0xD00UL)
...
struct DSI_REGS {
    ...
    u32 rsv_00A8[22];    /* 0A8..0FC */
    u32 DSI_PHY_PCPAT;    /* 00100 */
    ...
    u32 DSI_BIST_PATTERN;    /* 0178 */
    struct DSI_BIST_CON_REG DSI_BIST_CON;    /* 017C */
    u32 rsv_0180[8];    /* 180..19c */
    struct DSI_VM_CMD_CON_REG DSI_VM_CMD_CON;    /* 0200 */
    u32 rsv_0204;    /* 204 */
    u32 DSI_VM_CMD_DATA0;    /* 0208 */
    u32 DSI_VM_CMD_DATA4;    /* 020c */
    u32 DSI_VM_CMD_DATA8;    /* 0210 */
    u32 DSI_VM_CMD_DATAC;    /* 0214 */
    u32 DSI_VM_CMD_DATA10;    /* 0218 */
    u32 DSI_VM_CMD_DATA14;    /* 021c */
    u32 DSI_VM_CMD_DATA18;    /* 0220 */
    u32 DSI_VM_CMD_DATA1C;    /* 0224 */
};
struct DSI_REGS_TYPE {
    ...
    u32 DSI_INTEN;    /* 0008 */
    u32 DSI_INTSTA;    /* 000C */
    u32 DSI_COM_CTRL;    /* 0010 */
    u32 DSI_MODE_CTRL;    /* 0014 */
    u32 DSI_TXRX_CTRL;    /* 0018 */
    u32 DSI_PSCTRL;    /* 001C */
    u32 DSI_VSA_NL;    /* 0020 */
    u32 DSI_VBP_NL;    /* 0024 */
    u32 DSI_VFP_NL;    /* 0028 */
    u32 DSI_VACT_NL;    /* 002C */
    u32 DSI_LFR_CON;    /* 0030 */
    u32 DSI_LFR_STA;    /* 0034 */
    u32 DSI_SIZE_CON;    /* 0038 */
    u32 rsv_3c[5];    /* 003C..004C */
    u32 DSI_HSA_WC;    /* 0050 */
    u32 DSI_HBP_WC;    /* 0054 */
    u32 DSI_HFP_WC;    /* 0058 */
    u32 DSI_BLLP_WC;    /* 005C */
    u32 DSI_CMDQ_SIZE;    /* 0060 */
    u32 DSI_HSTX_CKL_WC;    /* 0064 */
    u32 DSI_HSTX_CKL_WC_AUTO_RESULT;    /* 0068 */
    u32 rsv_006C[2];    /* 006c..0070 */
    u32 DSI_RX_DATA0;    /* 0074 */
    u32 DSI_RX_DATA1;    /* 0078 */
    u32 DSI_RX_DATA2;    /* 007c */
    u32 DSI_RX_DATA3;    /* 0080 */
    u32 DSI_RACK;    /* 0084 */
    u32 DSI_TRIG_STA;    /* 0088 */
    u32 rsv_008C;    /* 008C */
    u32 DSI_MEM_CONTI;    /* 0090 */
    u32 DSI_FRM_BC;    /* 0094 */
    u32 DSI_3D_CON;    /* 0098 */
    u32 rsv_009C;    /* 009c */
    u32 DSI_TIME_CON0;    /* 00A0 */
    u32 DSI_TIME_CON1;    /* 00A4 */

    u32 rsv_00A8[22];    /* 0A8..0FC */
    u32 DSI_PHY_PCPAT;    /* 00100 */

    u32 DSI_PHY_LCCON;    /* 0104 */
    u32 DSI_PHY_LD0CON;    /* 0108 */
    u32 DSI_PHY_SYNCON;    /* 010C */
    u32 DSI_PHY_TIMECON0;    /* 0110 */
    u32 DSI_PHY_TIMECON1;    /* 0114 */
    u32 DSI_PHY_TIMECON2;    /* 0118 */
    u32 DSI_PHY_TIMECON3;    /* 011C */
    u32 rsv_0120[9];    /* 0120..0140 */
    u32 DSI_CKSM_OUT;    /* 0144 */
    u32 DSI_STATE_DBG0;    /* 0148 */
    u32 DSI_STATE_DBG1;    /* 014C */
    u32 DSI_STATE_DBG2;    /* 0150 */
    u32 DSI_STATE_DBG3;    /* 0154 */
    u32 DSI_STATE_DBG4;    /* 0158 */
    u32 DSI_STATE_DBG5;    /* 015C */
    u32 DSI_STATE_DBG6;    /* 0160 */
    u32 DSI_STATE_DBG7;    /* 0164 */
    u32 DSI_STATE_DBG8;    /* 0168 */
    u32 DSI_STATE_DBG9;    /* 016C */
    u32 DSI_DEBUG_SEL;    /* 0170 */
    u32 DSI_STATE_DBG10;    /* 0174 */
    u32 DSI_BIST_PATTERN;    /* 0178 */
    u32 DSI_BIST_CON;    /* 017C */
    u32 rsv_0180[8];    /* 180..19c*/
    u32 DSI_VM_CMD_CON;    /* 0200 */
    u32 rsv_0204;    /* 204 */
    u32 DSI_VM_CMD_DATA0;    /* 0208 */
    u32 DSI_VM_CMD_DATA4;    /* 020c */
    u32 DSI_VM_CMD_DATA8;    /* 0210 */
...
struct DSI_CMDQ_REGS_TYPE {
    u32 data[128]; /* only support 128 cmdq */
};
