...
#define DP_COLORFMT_PACK(VIDEO, PLANE, COPLANE, HFACTOR, VFACTOR, BITS, GROUP, SWAP_ENABLE,  \
                        UNIQUEID)                                                        \
    ((VIDEO         << 27) |                                                             \
     (PLANE         << 24) |                                                             \
     (COPLANE       << 22) |                                                             \
...
enum DpColorFormat  {
    ...
    DP_COLOR_420_BLKI     = DP_COLORFMT_PACK(3,   2,  1, 1, 1, 256, 1, 0, 12),//Field mode+Vdo mode
