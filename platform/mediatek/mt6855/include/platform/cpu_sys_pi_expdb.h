...
// Log @ CSRAM
//#define MCUPM_EEM_LOG_ADDR        (SRAM_BASE + 0x00012800) // 0x0011_2400
//#define MCUPM_EEM_LOG_SIZE        (0xC00)

#define MCUPM_PICACHU_LOG_ADDR    (SRAM_BASE + 0x00013400) // 0x0011_2E00
#define MCUPM_PICACHU_LOG_SIZE    (0xC00)

// Log @ MCUPM TCM
#define MCUPM_TCM_LOG_CNT         2

//#define MCUPM_SES_LOG_ADDR        \
                        (MCUPM_SRAM_BASE + (read32(GPR_BASE_ADDR(5))))
//#define MCUPM_SES_LOG_SIZE        \
                        ((read32(GPR_BASE_ADDR(6))) / MCUPM_TCM_LOG_CNT)

//#define MCUPM_DVCS_LOG_ADDR       (MCUPM_SRAM_BASE + \
                        (read32(GPR_BASE_ADDR(5))) + MCUPM_SES_LOG_SIZE)
//#define MCUPM_DVCS_LOG_SIZE       \
                        ((read32(GPR_BASE_ADDR(6))) / MCUPM_TCM_LOG_CNT)
