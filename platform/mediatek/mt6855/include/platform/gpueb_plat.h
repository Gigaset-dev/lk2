...
#define PLL4H_PLL3_CON1                     (GPUEB_PLL_BASE + 0x002C)

#define GPUEB_PLL                       PLL4H_PLL3_CON1
#define GPUEB_MUX                       MFG_RPC_AO_CLK_CFG

#define GPUEB_RSV_SYSRAM_BASE           (SRAM_BASE + 0x11400) // 0x00111400
...
#define GPUMPU_MEM_SIZE                 0x00000000  // 0MB, need to align DTS/EB setting
#define GPU_FW_PRV_HEAP                 0x00400000  // 4MB, need to align DTS/EB setting
