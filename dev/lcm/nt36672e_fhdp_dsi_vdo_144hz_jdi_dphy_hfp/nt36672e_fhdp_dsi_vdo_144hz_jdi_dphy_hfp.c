...
#define LCM_ID_NT36672E_JDI (0x0) //todo
#else
#define LCM_ID_NT36672E_JDI (0x41) //todo
#endif
...
static void lcm_get_params(LCM_PARAMS *params)
{
    ...
    params->dsi.horizontal_frontporch = 910;
    params->dsi.horizontal_active_pixel = FRAME_WIDTH;
    params->dsi.ssc_disable = 1;

#if (LCM_DSI_CMD_MODE)
    params->dsi.PLL_CLOCK = 648;    /* this value must be in MTK suggested table */
#else
    params->dsi.PLL_CLOCK = 648;    /* this value must be in MTK suggested table */
#endif
    params->dsi.data_rate = 1296;
...
LCM_DRIVER nt36672e_fhdp_dsi_vdo_144hz_jdi_dphy_hfp_lcm_drv = {
    .name = "nt36672e_fhdp_dsi_vdo_144hz_jdi_dphy_hfp_lcm_drv",
