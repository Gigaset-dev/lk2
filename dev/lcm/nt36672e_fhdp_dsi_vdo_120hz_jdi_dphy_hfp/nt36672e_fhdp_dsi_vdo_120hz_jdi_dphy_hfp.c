...
#define LCM_ID_NT36672E_JDI (0x6E) //nt36672e special register,is not compare id register
...
{0XC1, 16, {0X89, 0X28, 0X00, 0X08, 0X00, 0XAA, 0X02, 0X0E, 0X00, 0X2B, 0X00,
            0X07, 0X0D, 0XB7, 0X0C, 0XB7} },//JDI VESA
{0XC2, 2, {0X1B, 0XA0} },
...
{0XFF, 1, {0X20} },
{0XFB, 1, {0X01} },
{0XB0, 16, {0X00, 0XE2, 0X00, 0XE9, 0X00, 0XF6, 0X01, 0X01, 0X01, 0X0C,
            0X01, 0X15, 0X01, 0X20, 0X01, 0X28} },
{0XB1, 16, {0X01, 0X33, 0X01, 0X51, 0X01, 0X6E, 0X01, 0X9A, 0X01, 0XC0,
            0X01, 0XFD, 0X02, 0X34, 0X02, 0X35} },
{0XB2, 16, {0X02, 0X6B, 0X02, 0XA9, 0X02, 0XD1, 0X03, 0X04, 0X03, 0X25,
            0X03, 0X51, 0X03, 0X5F, 0X03, 0X6D} },
{0XB3, 14, {0X03, 0X7D, 0X03, 0X90, 0X03, 0XA7, 0X03, 0XBB, 0X03, 0XD4,
            0X03, 0XD8, 0X00, 0X00} },
{0XB4, 16, {0X00, 0XAA, 0X00, 0XB3, 0X00, 0XC4, 0X00, 0XD4, 0X00, 0XE2,
            0X00, 0XF0, 0X00, 0XFC, 0X01, 0X08} },
{0XB5, 16, {0X01, 0X12, 0X01, 0X39, 0X01, 0X58, 0X01, 0X8C, 0X01, 0XB5,
            0X01, 0XF7, 0X02, 0X30, 0X02, 0X31} },
{0XB6, 16, {0X02, 0X68, 0X02, 0XA6, 0X02, 0XCE, 0X03, 0X01, 0X03, 0X23,
            0X03, 0X4E, 0X03, 0X5C, 0X03, 0X6A} },
{0XB7, 14, {0X03, 0X7B, 0X03, 0X8E, 0X03, 0XA5, 0X03, 0XBB, 0X03, 0XD4,
            0X03, 0XD8, 0X00, 0X00} },
{0XB8, 16, {0X00, 0X00, 0X00, 0X20, 0X00, 0X47, 0X00, 0X65, 0X00, 0X85,
            0X00, 0X99, 0X00, 0XAD, 0X00, 0XC0} },
{0XB9, 16, {0X00, 0XD2, 0X01, 0X06, 0X01, 0X30, 0X01, 0X70, 0X01, 0X9F,
            0X01, 0XE8, 0X02, 0X25, 0X02, 0X26} },
{0XBA, 16, {0X02, 0X5F, 0X02, 0X9F, 0X02, 0XC7, 0X02, 0XFD, 0X03, 0X20,
            0X03, 0X52, 0X03, 0X63, 0X03, 0X67} },
{0XBB, 14, {0X03, 0X78, 0X03, 0X8B, 0X03, 0XA3, 0X03, 0XB9, 0X03, 0XD4,
            0X03, 0XD8, 0X00, 0X00} },
{0XFF, 1, {0X21} },
{0XFB, 1, {0X01} },
{0XB0, 16, {0X00, 0XE2, 0X00, 0XE9, 0X00, 0XF6, 0X01, 0X01, 0X01, 0X0C,
...
static void lcm_get_params(LCM_PARAMS *params)
{
    ...
    params->dsi.vertical_frontporch_for_low_power = 4180;
    params->dsi.vertical_active_line = FRAME_HEIGHT;

    params->dsi.horizontal_sync_active = 12;
    params->dsi.horizontal_backporch = 56;
    params->dsi.horizontal_frontporch = 714;
    params->dsi.horizontal_active_pixel = FRAME_WIDTH;
    params->dsi.ssc_disable = 1;

#if (LCM_DSI_CMD_MODE)
    params->dsi.PLL_CLOCK = 551;    /* this value must be in MTK suggested table */
#else
    params->dsi.PLL_CLOCK = 551;    /* this value must be in MTK suggested table */
#endif
    params->dsi.data_rate = 1102;
...
LCM_DRIVER nt36672e_fhdp_dsi_vdo_120hz_jdi_dphy_hfp_lcm_drv = {
    .name = "nt36672e_fhdp_dsi_vdo_120hz_jdi_dphy_hfp_lcm_drv",
