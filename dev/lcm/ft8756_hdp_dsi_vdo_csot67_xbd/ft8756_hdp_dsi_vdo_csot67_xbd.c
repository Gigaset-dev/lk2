...
//#define VBP (60)	
	...
	params->dsi.vertical_frontporch = 36;// 8  prize --»Æ¼ÌÎä--for shanping
    ...
    params->dsi.PLL_CLOCK= 540;        //4LANE   232
...
LCM_DRIVER ft8756_hdp_dsi_vdo_csot67_xbd_lcm_drv = 
{
    .name			= "ft8756_hdp_dsi_vdo_csot67_xbd",
