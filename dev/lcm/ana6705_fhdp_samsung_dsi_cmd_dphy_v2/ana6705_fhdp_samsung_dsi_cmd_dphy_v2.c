...
static struct LCM_setting_table init_setting[] = {
    //DSC 10bit
    {0x9E, 128, {0x11, 0x00, 0x00, 0xAB, 0x30, 0x80, 0x09, 0x6C, 0x04,
    ...
    /* CASET/PASET Setting */
    {0x2A, 0x04, {0x00, 0x00, 0x04, 0x37} }, //1439
    {0x2B, 0x04, {0x00, 0x00, 0x09, 0x6B} }, //3215

    /* Scaler Setting */
    {0xF0, 0x02, {0x5A, 0x5A} },
    {0xC3, 0x01, {0x89} },
    {0xB0, 0x03, {0x00, 0x24, 0xC3} },
    {0xC3, 0x11, {0xFD, 0x00, 0xFD, 0x00, 0xFD, 0x00, 0xFD, 0x00,
                0xFD, 0x00, 0xFD, 0x00, 0xFD, 0x00, 0xFD, 0x00,
                0xFD} },
    {0xB0, 0x03, {0x00, 0x3A, 0xC3} },
    {0xC3, 0x11, {0xB0, 0x00, 0xB0, 0x00, 0xB0, 0x00, 0xB0, 0x00,
                0xB0, 0x00, 0xB0, 0x00, 0xB0, 0x00, 0xB0, 0x00,
                0xB0} },
    {0xB0, 0x03, {0x00, 0x50, 0xC3} },
    {0xC3, 0x11, {0x43, 0x00, 0x43, 0x00, 0x43, 0x00, 0x43, 0x00,
                0x43, 0x00, 0x43, 0x00, 0x43, 0x00, 0x43, 0x00,
                0x43} },
    {0xB0, 0x03, {0x00, 0x61, 0xC3} },
    {0xC3, 0x16, {0xCC, 0xCC, 0xCC, 0xCC, 0xC0, 0xFE, 0x00, 0xFE,
    ...
    {0xB9, 0x01, {0x02} },
    {0xFD, 0x01, {0x4A} },
    {0xB0, 0x03, {0x00, 0x18, 0xF2} },
    {0xF2, 0x02, {0x1B, 0x50} },
    {0xB0, 0x03, {0x00, 0x74, 0xBD} },
    {0xBD, 0x01, {0x78} },
    {0xF2, 0x02, {0x01, 0x00} },
    {0x60, 0x01, {0x08} },
    {0xB0, 0x03, {0x00, 0x10, 0xF6} },
    {0xF6, 0x01, {0xAA} },
    {0xB0, 0x03, {0x00, 0x3F, 0xF6} },
    {0xF6, 0x01, {0x1F} },
    {0xB0, 0x03, {0x00, 0x45, 0xF6} },
    {0xF6, 0x01, {0x1F} },
    {0xB0, 0x03, {0x00, 0x6C, 0xBD} },
    {0xBD, 0x01, {0x80} },
    {0xB0, 0x03, {0x00, 0x6F, 0xBD} },
    {0xBD, 0x04, {0x45, 0x65, 0x65, 0x65} },
    {0xB0, 0x03, {0x00, 0x06, 0x60} },
    {0x60, 0x04, {0x00, 0x00, 0x00, 0x00} },
    {0xB0, 0x03, {0x00, 0x0A, 0x60} },
    {0x60, 0x04, {0x00, 0x00, 0x00, 0x00} },
    {0xB0, 0x03, {0x00, 0x0E, 0x60} },
    {0x60, 0x04, {0xFF, 0x00, 0x00, 0x00} },
    {0xB0, 0x03, {0x00, 0x13, 0x60} },
    {0x60, 0x04, {0xFF, 0x00, 0x00, 0x00} },
    {0xB0, 0x03, {0x00, 0x18, 0x60} },
    /* oplus adfr -> max:min */
    {0x60, 0x02, {0x0C, 0x03} },
    {0xB0, 0x03, {0x00, 0x04, 0x60} },
    {0x60, 0x02, {0x00, 0x00} },
    {0xB0, 0x03, {0x00, 0x02, 0x60} },
    {0x60, 0x01, {0x1C} },
...
static void lcm_get_params(LCM_PARAMS *params)
{
    ...
    params->dsi.PLL_CLOCK = 488;    /* this value must be in MTK suggested table */
    params->dsi.data_rate  = 488 * 2;  /* this value must be in MTK suggested table */
    ...
    params->dsi.dsc_params.pic_height = FRAME_HEIGHT;//PPS6[7:0],PPS7[7:0]0xc90
    params->dsi.dsc_params.pic_width = FRAME_WIDTH;//PPS8[7:0],PPS9[7:0]0x5a0
    params->dsi.dsc_params.slice_height = 36;//PPS10[7:0],PPS11[7:0]0x018
    params->dsi.dsc_params.slice_width = 540;//PPS12[7:0],PPS13[7:0]0x2d0
    params->dsi.dsc_params.chunk_size = 540;//PPS14[7:0],PPS15[7:0]0x2d0
    params->dsi.dsc_params.xmit_delay = 512;//PPS16[1:0],PPS17[7:0]0x200
    params->dsi.dsc_params.dec_delay = 571;//PPS18[7:0],PPS19[7:0]0x286
    params->dsi.dsc_params.scale_value = 32;//PPS21[5:0]0x20
    params->dsi.dsc_params.increment_interval = 821;//PPS22[7:0],PPS23[7:0]0x283
    params->dsi.dsc_params.decrement_interval = 7;//PPS24[3:0],PPS25[7:0]0x0a
    params->dsi.dsc_params.line_bpg_offset = 14;//PPS27[4:0]0x0D
    params->dsi.dsc_params.nfl_bpg_offset = 820;//PPS28[7:0],PPS29[7:0]0x486
    params->dsi.dsc_params.slice_bpg_offset = 724;//PPS30[7:0],PPS31[7:0]0x32E
...
LCM_DRIVER ana6705_fhdp_samsung_dsi_cmd_dphy_lcm_drv_v2 = {
    .name = "ana6705_fhdp_samsung_dsi_cmd_dphy_lcm_drv_v2",
