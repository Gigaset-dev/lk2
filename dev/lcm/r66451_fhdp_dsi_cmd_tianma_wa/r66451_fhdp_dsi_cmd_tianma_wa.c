...
static void lcm_get_params(LCM_PARAMS *params)
{
    ...
    params->dsi.cmd_null_pkt_en = 0;
    params->dsi.cmd_null_pkt_len = 105;
#ifndef MACH_FPGA
#if (LCM_DSI_CMD_MODE)
    params->dsi.PLL_CLOCK = 270; /* ori clk = 570M, 1/3 compression */
#else
...
LCM_DRIVER r66451_fhdp_dsi_cmd_tianma_wa_lcm_drv = {
    .name = "r66451_fhdp_dsi_cmd_tianma_wa_drv",
